...
class AccessInfo(Type):
    ...
    def __init__(self, role=None, scope_tag=None, target_tag=None, **unknown_fields):
        ...
        if role_ is not None and not isinstance(role_, (bytes, str)):
            raise Exception(
                "Expected role_ to be a str, received: {}".format(type(role_))
            )

        if scope_tag_ is not None and not isinstance(scope_tag_, (bytes, str)):
            raise Exception(
                "Expected scope_tag_ to be a str, received: {}".format(type(scope_tag_))
            )

        if target_tag_ is not None and not isinstance(target_tag_, (bytes, str)):
            raise Exception(
                "Expected target_tag_ to be a str, received: {}".format(
                    type(target_tag_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if execution_group_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected execution_group_ to be a str, received: {}".format(
                    type(execution_group_)
                )
            )

        if name_ is not None and not isinstance(name_, (bytes, str)):
            raise Exception(
                "Expected name_ to be a str, received: {}".format(type(name_))
            )

        if parallel_ is not None and not isinstance(parallel_, bool):
            raise Exception(
                "Expected parallel_ to be a bool, received: {}".format(type(parallel_))
            )

        if parameters_ is not None and not isinstance(parameters_, dict):
            raise Exception(
                "Expected parameters_ to be a Mapping, received: {}".format(
                    type(parameters_)
                )
            )
        ...
        if receiver_ is not None and not isinstance(receiver_, (bytes, str)):
            raise Exception(
                "Expected receiver_ to be a str, received: {}".format(type(receiver_))
            )

        if tag_ is not None and not isinstance(tag_, (bytes, str)):
            raise Exception(
                "Expected tag_ to be a str, received: {}".format(type(tag_))
            )
...
class ActionMessage(Type):
    ...
    def __init__(self, message=None, timestamp=None, **unknown_fields):
        ...
        if message_ is not None and not isinstance(message_, (bytes, str)):
            raise Exception(
                "Expected message_ to be a str, received: {}".format(type(message_))
            )

        if timestamp_ is not None and not isinstance(timestamp_, (bytes, str)):
            raise Exception(
                "Expected timestamp_ to be a str, received: {}".format(type(timestamp_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if action_ is not None and not isinstance(action_, (dict, Action)):
            raise Exception(
                "Expected action_ to be a Action, received: {}".format(type(action_))
            )

        if completed_ is not None and not isinstance(completed_, (bytes, str)):
            raise Exception(
                "Expected completed_ to be a str, received: {}".format(type(completed_))
            )

        if enqueued_ is not None and not isinstance(enqueued_, (bytes, str)):
            raise Exception(
                "Expected enqueued_ to be a str, received: {}".format(type(enqueued_))
            )

        if error_ is not None and not isinstance(error_, (dict, Error)):
            raise Exception(
                "Expected error_ to be a Error, received: {}".format(type(error_))
            )

        if log_ is not None and not isinstance(log_, (bytes, str, list)):
            raise Exception(
                "Expected log_ to be a Sequence, received: {}".format(type(log_))
            )
        ...
        if output_ is not None and not isinstance(output_, dict):
            raise Exception(
                "Expected output_ to be a Mapping, received: {}".format(type(output_))
            )

        if started_ is not None and not isinstance(started_, (bytes, str)):
            raise Exception(
                "Expected started_ to be a str, received: {}".format(type(started_))
            )

        if status_ is not None and not isinstance(status_, (bytes, str)):
            raise Exception(
                "Expected status_ to be a str, received: {}".format(type(status_))
            )
...
class ActionResults(Type):
    ...
    def __init__(self, results=None, **unknown_fields):
        ...
        if results_ is not None and not isinstance(results_, (bytes, str, list)):
            raise Exception(
                "Expected results_ to be a Sequence, received: {}".format(
                    type(results_)
                )
            )
...
class ActionSpec(Type):
    ...
    def __init__(self, description=None, params=None, **unknown_fields):
        ...
        if description_ is not None and not isinstance(description_, (bytes, str)):
            raise Exception(
                "Expected description_ to be a str, received: {}".format(
                    type(description_)
                )
            )
        ...
        if params_ is not None and not isinstance(params_, dict):
            raise Exception(
                "Expected params_ to be a Mapping, received: {}".format(type(params_))
            )
...
class Actions(Type):
    ...
    def __init__(self, actions=None, **unknown_fields):
        ...
        if actions_ is not None and not isinstance(actions_, (bytes, str, list)):
            raise Exception(
                "Expected actions_ to be a Sequence, received: {}".format(
                    type(actions_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if application_description_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_description_ to be a str, received: {}".format(
                    type(application_description_)
                )
            )
        ...
        if application_name_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_name_ to be a str, received: {}".format(
                    type(application_name_)
                )
            )

        if endpoints_ is not None and not isinstance(endpoints_, dict):
            raise Exception(
                "Expected endpoints_ to be a Mapping, received: {}".format(
                    type(endpoints_)
                )
            )
        ...
        if model_tag_ is not None and not isinstance(model_tag_, (bytes, str)):
            raise Exception(
                "Expected model_tag_ to be a str, received: {}".format(type(model_tag_))
            )

        if offer_name_ is not None and not isinstance(offer_name_, (bytes, str)):
            raise Exception(
                "Expected offer_name_ to be a str, received: {}".format(
                    type(offer_name_)
                )
            )
        ...
        if owner_tag_ is not None and not isinstance(owner_tag_, (bytes, str)):
            raise Exception(
                "Expected owner_tag_ to be a str, received: {}".format(type(owner_tag_))
            )
...
class AddApplicationOffers(Type):
    ...
    def __init__(self, offers=None, **unknown_fields):
        ...
        if offers_ is not None and not isinstance(offers_, (bytes, str, list)):
            raise Exception(
                "Expected offers_ to be a Sequence, received: {}".format(type(offers_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if application_ is not None and not isinstance(application_, (bytes, str)):
            raise Exception(
                "Expected application_ to be a str, received: {}".format(
                    type(application_)
                )
            )
        ...
        if attach_storage_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected attach_storage_ to be a Sequence, received: {}".format(
                    type(attach_storage_)
                )
            )

        if num_units_ is not None and not isinstance(num_units_, int):
            raise Exception(
                "Expected num_units_ to be a int, received: {}".format(type(num_units_))
            )

        if placement_ is not None and not isinstance(placement_, (bytes, str, list)):
            raise Exception(
                "Expected placement_ to be a Sequence, received: {}".format(
                    type(placement_)
                )
            )
        ...
        if policy_ is not None and not isinstance(policy_, (bytes, str)):
            raise Exception(
                "Expected policy_ to be a str, received: {}".format(type(policy_))
            )
...
class AddApplicationUnitsResults(Type):
    ...
    def __init__(self, units=None, **unknown_fields):
        ...
        if units_ is not None and not isinstance(units_, (bytes, str, list)):
            raise Exception(
                "Expected units_ to be a Sequence, received: {}".format(type(units_))
            )
...
class AddCharmWithOrigin(Type):
    ...
    def __init__(self, charm_origin=None, force=None, url=None, **unknown_fields):
        ...
        if charm_origin_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected charm_origin_ to be a CharmOrigin, received: {}".format(
                    type(charm_origin_)
                )
            )
        ...
        if force_ is not None and not isinstance(force_, bool):
            raise Exception(
                "Expected force_ to be a bool, received: {}".format(type(force_))
            )

        if url_ is not None and not isinstance(url_, (bytes, str)):
            raise Exception(
                "Expected url_ to be a str, received: {}".format(type(url_))
            )
...
class AddCloudArgs(Type):
    ...
    def __init__(self, cloud=None, force=None, name=None, **unknown_fields):
        ...
        if cloud_ is not None and not isinstance(cloud_, (dict, Cloud)):
            raise Exception(
                "Expected cloud_ to be a Cloud, received: {}".format(type(cloud_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if addresses_ is not None and not isinstance(addresses_, (bytes, str, list)):
            raise Exception(
                "Expected addresses_ to be a Sequence, received: {}".format(
                    type(addresses_)
                )
            )
        ...
        if base_ is not None and not isinstance(base_, (dict, Base)):
            raise Exception(
                "Expected base_ to be a Base, received: {}".format(type(base_))
            )

        if constraints_ is not None and not isinstance(constraints_, (dict, Value)):
            raise Exception(
                "Expected constraints_ to be a Value, received: {}".format(
                    type(constraints_)
                )
            )
        ...
        if container_type_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected container_type_ to be a str, received: {}".format(
        ...
        if disks_ is not None and not isinstance(disks_, (bytes, str, list)):
            raise Exception(
                "Expected disks_ to be a Sequence, received: {}".format(type(disks_))
            )
        ...
        if hardware_characteristics_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected hardware_characteristics_ to be a HardwareCharacteristics, received: {}".format(
                    type(hardware_characteristics_)
                )
            )

        if instance_id_ is not None and not isinstance(instance_id_, (bytes, str)):
            raise Exception(
                "Expected instance_id_ to be a str, received: {}".format(
                    type(instance_id_)
                )
            )
        ...
        if jobs_ is not None and not isinstance(jobs_, (bytes, str, list)):
            raise Exception(
                "Expected jobs_ to be a Sequence, received: {}".format(type(jobs_))
            )

        if nonce_ is not None and not isinstance(nonce_, (bytes, str)):
            raise Exception(
                "Expected nonce_ to be a str, received: {}".format(type(nonce_))
            )

        if parent_id_ is not None and not isinstance(parent_id_, (bytes, str)):
            raise Exception(
                "Expected parent_id_ to be a str, received: {}".format(type(parent_id_))
            )

        if placement_ is not None and not isinstance(placement_, (dict, Placement)):
            raise Exception(
                "Expected placement_ to be a Placement, received: {}".format(
                    type(placement_)
                )
            )
...
class AddMachines(Type):
    ...
    def __init__(self, params=None, **unknown_fields):
        ...
        if params_ is not None and not isinstance(params_, (bytes, str, list)):
            raise Exception(
                "Expected params_ to be a Sequence, received: {}".format(type(params_))
            )
...
class AddMachinesResult(Type):
    ...
    def __init__(self, error=None, machine=None, **unknown_fields):
        ...
        if machine_ is not None and not isinstance(machine_, (bytes, str)):
            raise Exception(
                "Expected machine_ to be a str, received: {}".format(type(machine_))
            )
...
class AddMachinesResults(Type):
    ...
    def __init__(self, machines=None, **unknown_fields):
        ...
        if machines_ is not None and not isinstance(machines_, (bytes, str, list)):
            raise Exception(
                "Expected machines_ to be a Sequence, received: {}".format(
                    type(machines_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if entity_ is not None and not isinstance(entity_, (dict, Entity)):
            raise Exception(
                "Expected entity_ to be a Entity, received: {}".format(type(entity_))
            )
        ...
        if macaroon_ is not None and not isinstance(macaroon_, (dict, Macaroon)):
            raise Exception(
                "Expected macaroon_ to be a Macaroon, received: {}".format(
                    type(macaroon_)
                )
            )
        ...
        if resources_ is not None and not isinstance(resources_, (bytes, str, list)):
            raise Exception(
                "Expected resources_ to be a Sequence, received: {}".format(
                    type(resources_)
                )
            )
...
class AddPendingResourcesResult(Type):
    ...
    def __init__(
        ...
        if errorresult_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected errorresult_ to be a ErrorResult, received: {}".format(
                    type(errorresult_)
                )
            )
        ...
        if pending_ids_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected pending_ids_ to be a Sequence, received: {}".format(
                    type(pending_ids_)
                )
            )
...
class AddRelation(Type):
    ...
    def __init__(self, endpoints=None, via_cidrs=None, **unknown_fields):
        ...
        if endpoints_ is not None and not isinstance(endpoints_, (bytes, str, list)):
            raise Exception(
                "Expected endpoints_ to be a Sequence, received: {}".format(
                    type(endpoints_)
                )
            )
        ...
        if via_cidrs_ is not None and not isinstance(via_cidrs_, (bytes, str, list)):
            raise Exception(
                "Expected via_cidrs_ to be a Sequence, received: {}".format(
                    type(via_cidrs_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if secretbackend_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected secretbackend_ to be a SecretBackend, received: {}".format(
                    type(secretbackend_)
                )
            )
        ...
        if backend_type_ is not None and not isinstance(backend_type_, (bytes, str)):
            raise Exception(
                "Expected backend_type_ to be a str, received: {}".format(
                    type(backend_type_)
                )
            )
        ...
        if config_ is not None and not isinstance(config_, dict):
            raise Exception(
                "Expected config_ to be a Mapping, received: {}".format(type(config_))
            )

        if id__ is not None and not isinstance(id__, (bytes, str)):
            raise Exception(
                "Expected id__ to be a str, received: {}".format(type(id__))
            )
        ...
        if token_rotate_interval_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected token_rotate_interval_ to be a int, received: {}".format(
                    type(token_rotate_interval_)
                )
            )
...
class AddSecretBackendArgs(Type):
    ...
    def __init__(self, args=None, **unknown_fields):
        ...
        if args_ is not None and not isinstance(args_, (bytes, str, list)):
            raise Exception(
                "Expected args_ to be a Sequence, received: {}".format(type(args_))
            )
...
class AddStorageDetails(Type):
    ...
    def __init__(self, storage_tags=None, **unknown_fields):
        ...
        if storage_tags_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_tags_ to be a Sequence, received: {}".format(
                    type(storage_tags_)
                )
            )
...
class AddStorageResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, AddStorageDetails)):
            raise Exception(
                "Expected result_ to be a AddStorageDetails, received: {}".format(
                    type(result_)
                )
            )
...
class AddUser(Type):
    ...
    def __init__(
        ...
        if display_name_ is not None and not isinstance(display_name_, (bytes, str)):
            raise Exception(
                "Expected display_name_ to be a str, received: {}".format(
                    type(display_name_)
                )
            )
        ...
        if password_ is not None and not isinstance(password_, (bytes, str)):
            raise Exception(
                "Expected password_ to be a str, received: {}".format(type(password_))
            )

        if username_ is not None and not isinstance(username_, (bytes, str)):
            raise Exception(
                "Expected username_ to be a str, received: {}".format(type(username_))
            )
...
class AddUserResult(Type):
    ...
    def __init__(self, error=None, secret_key=None, tag=None, **unknown_fields):
        ...
        if secret_key_ is not None and not isinstance(secret_key_, (bytes, str, list)):
            raise Exception(
                "Expected secret_key_ to be a Sequence, received: {}".format(
                    type(secret_key_)
                )
            )
...
class AddUsers(Type):
    ...
    def __init__(self, users=None, **unknown_fields):
        ...
        if users_ is not None and not isinstance(users_, (bytes, str, list)):
            raise Exception(
                "Expected users_ to be a Sequence, received: {}".format(type(users_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cidr_ is not None and not isinstance(cidr_, (bytes, str)):
            raise Exception(
                "Expected cidr_ to be a str, received: {}".format(type(cidr_))
            )

        if config_type_ is not None and not isinstance(config_type_, (bytes, str)):
            raise Exception(
                "Expected config_type_ to be a str, received: {}".format(
                    type(config_type_)
                )
            )
        ...
        if is_secondary_ is not None and not isinstance(is_secondary_, bool):
            raise Exception(
                "Expected is_secondary_ to be a bool, received: {}".format(
                    type(is_secondary_)
                )
            )
        ...
        if scope_ is not None and not isinstance(scope_, (bytes, str)):
            raise Exception(
                "Expected scope_ to be a str, received: {}".format(type(scope_))
            )

        if space_id_ is not None and not isinstance(space_id_, (bytes, str)):
            raise Exception(
                "Expected space_id_ to be a str, received: {}".format(type(space_id_))
            )

        if space_name_ is not None and not isinstance(space_name_, (bytes, str)):
            raise Exception(
                "Expected space_name_ to be a str, received: {}".format(
                    type(space_name_)
                )
            )
        ...
        if type__ is not None and not isinstance(type__, (bytes, str)):
            raise Exception(
                "Expected type__ to be a str, received: {}".format(type(type__))
            )

        if value_ is not None and not isinstance(value_, (bytes, str)):
            raise Exception(
                "Expected value_ to be a str, received: {}".format(type(value_))
            )
...
class AllWatcherId(Type):
    ...
    def __init__(self, watcher_id=None, **unknown_fields):
        ...
        if watcher_id_ is not None and not isinstance(watcher_id_, (bytes, str)):
            raise Exception(
                "Expected watcher_id_ to be a str, received: {}".format(
                    type(watcher_id_)
                )
            )
...
class AllWatcherNextResults(Type):
    ...
    def __init__(self, deltas=None, **unknown_fields):
        ...
        if deltas_ is not None and not isinstance(deltas_, (bytes, str, list)):
            raise Exception(
                "Expected deltas_ to be a Sequence, received: {}".format(type(deltas_))
            )
...
class AnnotationsGetResult(Type):
    ...
    def __init__(self, annotations=None, entity=None, error=None, **unknown_fields):
        ...
        if annotations_ is not None and not isinstance(annotations_, dict):
            raise Exception(
                "Expected annotations_ to be a Mapping, received: {}".format(
                    type(annotations_)
                )
            )
        ...
        if entity_ is not None and not isinstance(entity_, (bytes, str)):
            raise Exception(
                "Expected entity_ to be a str, received: {}".format(type(entity_))
            )

        if error_ is not None and not isinstance(error_, (dict, ErrorResult)):
            raise Exception(
                "Expected error_ to be a ErrorResult, received: {}".format(type(error_))
            )
...
class AnnotationsSet(Type):
    ...
    def __init__(self, annotations=None, **unknown_fields):
        ...
        if annotations_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected annotations_ to be a Sequence, received: {}".format(
                    type(annotations_)
                )
            )
...
class ApplicationCharmActionsResult(Type):
    ...
    def __init__(
        ...
        if actions_ is not None and not isinstance(actions_, dict):
            raise Exception(
                "Expected actions_ to be a Mapping, received: {}".format(type(actions_))
            )
        ...
        if application_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_tag_ to be a str, received: {}".format(
                    type(application_tag_)
                )
            )
...
class ApplicationCharmPlacement(Type):
    ...
    def __init__(self, application=None, charm_url=None, **unknown_fields):
        ...
        if charm_url_ is not None and not isinstance(charm_url_, (bytes, str)):
            raise Exception(
                "Expected charm_url_ to be a str, received: {}".format(type(charm_url_))
            )
...
class ApplicationCharmPlacements(Type):
    ...
    def __init__(self, placements=None, **unknown_fields):
        ...
        if placements_ is not None and not isinstance(placements_, (bytes, str, list)):
            raise Exception(
                "Expected placements_ to be a Sequence, received: {}".format(
                    type(placements_)
                )
            )
...
class ApplicationCharmRelationsResults(Type):
    ...
    def __init__(self, charm_relations=None, **unknown_fields):
        ...
        if charm_relations_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected charm_relations_ to be a Sequence, received: {}".format(
                    type(charm_relations_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if channel_ is not None and not isinstance(channel_, (bytes, str)):
            raise Exception(
                "Expected channel_ to be a str, received: {}".format(type(channel_))
            )
        ...
        if config_yaml_ is not None and not isinstance(config_yaml_, (bytes, str)):
            raise Exception(
                "Expected config_yaml_ to be a str, received: {}".format(
                    type(config_yaml_)
                )
            )
        ...
        if devices_ is not None and not isinstance(devices_, dict):
            raise Exception(
                "Expected devices_ to be a Mapping, received: {}".format(type(devices_))
            )

        if endpoint_bindings_ is not None and not isinstance(endpoint_bindings_, dict):
            raise Exception(
                "Expected endpoint_bindings_ to be a Mapping, received: {}".format(
                    type(endpoint_bindings_)
                )
            )
        ...
        if resources_ is not None and not isinstance(resources_, dict):
            raise Exception(
                "Expected resources_ to be a Mapping, received: {}".format(
                    type(resources_)
                )
            )
        ...
        if storage_ is not None and not isinstance(storage_, dict):
            raise Exception(
                "Expected storage_ to be a Mapping, received: {}".format(type(storage_))
            )
...
class ApplicationExpose(Type):
    ...
    def __init__(self, application=None, exposed_endpoints=None, **unknown_fields):
        ...
        if exposed_endpoints_ is not None and not isinstance(exposed_endpoints_, dict):
            raise Exception(
                "Expected exposed_endpoints_ to be a Mapping, received: {}".format(
                    type(exposed_endpoints_)
                )
            )
...
class ApplicationGet(Type):
    ...
    def __init__(self, application=None, branch=None, **unknown_fields):
        ...
        if branch_ is not None and not isinstance(branch_, (bytes, str)):
            raise Exception(
                "Expected branch_ to be a str, received: {}".format(type(branch_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if application_config_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_config_ to be a Mapping, received: {}".format(
                    type(application_config_)
                )
            )
        ...
        if charm_ is not None and not isinstance(charm_, (bytes, str)):
            raise Exception(
                "Expected charm_ to be a str, received: {}".format(type(charm_))
            )
...
class ApplicationInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ApplicationResult)):
            raise Exception(
                "Expected result_ to be a ApplicationResult, received: {}".format(
                    type(result_)
                )
            )
...
class ApplicationMergeBindings(Type):
    ...
    def __init__(
        ...
        if bindings_ is not None and not isinstance(bindings_, dict):
            raise Exception(
                "Expected bindings_ to be a Mapping, received: {}".format(
                    type(bindings_)
                )
            )
...
class ApplicationMetricCredential(Type):
    ...
    def __init__(self, application=None, metrics_credentials=None, **unknown_fields):
        ...
        if metrics_credentials_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected metrics_credentials_ to be a Sequence, received: {}".format(
                    type(metrics_credentials_)
                )
            )
...
class ApplicationMetricCredentials(Type):
    ...
    def __init__(self, creds=None, **unknown_fields):
        ...
        if creds_ is not None and not isinstance(creds_, (bytes, str, list)):
            raise Exception(
                "Expected creds_ to be a Sequence, received: {}".format(type(creds_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if applicationofferdetails_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected applicationofferdetails_ to be a ApplicationOfferDetails, received: {}".format(
                    type(applicationofferdetails_)
                )
            )
        ...
        if connections_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected connections_ to be a Sequence, received: {}".format(
                    type(connections_)
                )
            )
        ...
        if offer_url_ is not None and not isinstance(offer_url_, (bytes, str)):
            raise Exception(
                "Expected offer_url_ to be a str, received: {}".format(type(offer_url_))
            )

        if offer_uuid_ is not None and not isinstance(offer_uuid_, (bytes, str)):
            raise Exception(
                "Expected offer_uuid_ to be a str, received: {}".format(
                    type(offer_uuid_)
                )
            )
        ...
        if source_model_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected source_model_tag_ to be a str, received: {}".format(
                    type(source_model_tag_)
                )
            )

        if spaces_ is not None and not isinstance(spaces_, (bytes, str, list)):
            raise Exception(
                "Expected spaces_ to be a Sequence, received: {}".format(type(spaces_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if applicationofferdetailsv5_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected applicationofferdetailsv5_ to be a ApplicationOfferDetailsV5, received: {}".format(
                    type(applicationofferdetailsv5_)
                )
            )
...
class ApplicationOfferResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected result_ to be a ApplicationOfferAdminDetailsV5, received: {}".format(
                    type(result_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if active_connected_count_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected active_connected_count_ to be a int, received: {}".format(
                    type(active_connected_count_)
                )
            )
        ...
        if err_ is not None and not isinstance(err_, (dict, Error)):
            raise Exception(
                "Expected err_ to be a Error, received: {}".format(type(err_))
            )
        ...
        if total_connected_count_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected total_connected_count_ to be a int, received: {}".format(
                    type(total_connected_count_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if exposed_ is not None and not isinstance(exposed_, bool):
            raise Exception(
                "Expected exposed_ to be a bool, received: {}".format(type(exposed_))
            )
        ...
        if life_ is not None and not isinstance(life_, (bytes, str)):
            raise Exception(
                "Expected life_ to be a str, received: {}".format(type(life_))
            )

        if principal_ is not None and not isinstance(principal_, bool):
            raise Exception(
                "Expected principal_ to be a bool, received: {}".format(
                    type(principal_)
                )
            )
        ...
        if remote_ is not None and not isinstance(remote_, bool):
            raise Exception(
                "Expected remote_ to be a bool, received: {}".format(type(remote_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if config_settings_ is not None and not isinstance(config_settings_, dict):
            raise Exception(
                "Expected config_settings_ to be a Mapping, received: {}".format(
                    type(config_settings_)
                )
            )
        ...
        if config_settings_yaml_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected config_settings_yaml_ to be a str, received: {}".format(
                    type(config_settings_yaml_)
                )
            )
        ...
        if force_base_ is not None and not isinstance(force_base_, bool):
            raise Exception(
                "Expected force_base_ to be a bool, received: {}".format(
                    type(force_base_)
                )
            )
        ...
        if force_units_ is not None and not isinstance(force_units_, bool):
            raise Exception(
                "Expected force_units_ to be a bool, received: {}".format(
                    type(force_units_)
                )
            )
        ...
        if generation_ is not None and not isinstance(generation_, (bytes, str)):
            raise Exception(
                "Expected generation_ to be a str, received: {}".format(
                    type(generation_)
                )
            )
        ...
        if resource_ids_ is not None and not isinstance(resource_ids_, dict):
            raise Exception(
                "Expected resource_ids_ to be a Mapping, received: {}".format(
                    type(resource_ids_)
                )
            )
        ...
        if storage_constraints_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_constraints_ to be a Mapping, received: {}".format(
                    type(storage_constraints_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if can_upgrade_to_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected can_upgrade_to_ to be a str, received: {}".format(
                    type(can_upgrade_to_)
                )
            )
        ...
        if charm_channel_ is not None and not isinstance(charm_channel_, (bytes, str)):
            raise Exception(
                "Expected charm_channel_ to be a str, received: {}".format(
                    type(charm_channel_)
                )
            )
        ...
        if charm_profile_ is not None and not isinstance(charm_profile_, (bytes, str)):
            raise Exception(
                "Expected charm_profile_ to be a str, received: {}".format(
                    type(charm_profile_)
                )
            )
        ...
        if charm_version_ is not None and not isinstance(charm_version_, (bytes, str)):
            raise Exception(
                "Expected charm_version_ to be a str, received: {}".format(
                    type(charm_version_)
                )
            )
        ...
        if int__ is not None and not isinstance(int__, int):
            raise Exception(
                "Expected int__ to be a int, received: {}".format(type(int__))
            )
        ...
        if meter_statuses_ is not None and not isinstance(meter_statuses_, dict):
            raise Exception(
                "Expected meter_statuses_ to be a Mapping, received: {}".format(
                    type(meter_statuses_)
                )
            )

        if provider_id_ is not None and not isinstance(provider_id_, (bytes, str)):
            raise Exception(
                "Expected provider_id_ to be a str, received: {}".format(
                    type(provider_id_)
                )
            )
        ...
        if public_address_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected public_address_ to be a str, received: {}".format(
                    type(public_address_)
                )
            )

        if relations_ is not None and not isinstance(relations_, dict):
            raise Exception(
                "Expected relations_ to be a Mapping, received: {}".format(
                    type(relations_)
                )
            )
        ...
        if status_ is not None and not isinstance(status_, (dict, DetailedStatus)):
            raise Exception(
                "Expected status_ to be a DetailedStatus, received: {}".format(
                    type(status_)
                )
            )
        ...
        if subordinate_to_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected subordinate_to_ to be a Sequence, received: {}".format(
                    type(subordinate_to_)
                )
            )

        if units_ is not None and not isinstance(units_, dict):
            raise Exception(
                "Expected units_ to be a Mapping, received: {}".format(type(units_))
            )
        ...
        if workload_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected workload_version_ to be a str, received: {}".format(
                    type(workload_version_)
                )
            )
...
class ApplicationUnexpose(Type):
    ...
    def __init__(self, application=None, exposed_endpoints=None, **unknown_fields):
        ...
        if exposed_endpoints_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected exposed_endpoints_ to be a Sequence, received: {}".format(
                    type(exposed_endpoints_)
                )
            )
...
class ApplicationUnset(Type):
    ...
    def __init__(self, application=None, branch=None, options=None, **unknown_fields):
        ...
        if options_ is not None and not isinstance(options_, (bytes, str, list)):
            raise Exception(
                "Expected options_ to be a Sequence, received: {}".format(
                    type(options_)
                )
            )
...
class ApplicationsDeploy(Type):
    ...
    def __init__(self, applications=None, **unknown_fields):
        ...
        if applications_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected applications_ to be a Sequence, received: {}".format(
                    type(applications_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if controller_access_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_access_ to be a str, received: {}".format(
                    type(controller_access_)
                )
            )

        if credentials_ is not None and not isinstance(credentials_, (bytes, str)):
            raise Exception(
                "Expected credentials_ to be a str, received: {}".format(
                    type(credentials_)
                )
            )
        ...
        if identity_ is not None and not isinstance(identity_, (bytes, str)):
            raise Exception(
                "Expected identity_ to be a str, received: {}".format(type(identity_))
            )
        ...
        if last_connection_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected last_connection_ to be a str, received: {}".format(
                    type(last_connection_)
                )
            )

        if model_access_ is not None and not isinstance(model_access_, (bytes, str)):
            raise Exception(
                "Expected model_access_ to be a str, received: {}".format(
                    type(model_access_)
                )
            )
...
class BackupsCreateArgs(Type):
    ...
    def __init__(self, no_download=None, notes=None, **unknown_fields):
        ...
        if no_download_ is not None and not isinstance(no_download_, bool):
            raise Exception(
                "Expected no_download_ to be a bool, received: {}".format(
                    type(no_download_)
                )
            )
        ...
        if notes_ is not None and not isinstance(notes_, (bytes, str)):
            raise Exception(
                "Expected notes_ to be a str, received: {}".format(type(notes_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if base_ is not None and not isinstance(base_, (bytes, str)):
            raise Exception(
                "Expected base_ to be a str, received: {}".format(type(base_))
            )

        if checksum_ is not None and not isinstance(checksum_, (bytes, str)):
            raise Exception(
                "Expected checksum_ to be a str, received: {}".format(type(checksum_))
            )
        ...
        if checksum_format_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected checksum_format_ to be a str, received: {}".format(
                    type(checksum_format_)
                )
            )
        ...
        if controller_machine_id_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_machine_id_ to be a str, received: {}".format(
                    type(controller_machine_id_)
                )
            )
        ...
        if controller_machine_inst_id_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_machine_inst_id_ to be a str, received: {}".format(
                    type(controller_machine_inst_id_)
                )
            )
        ...
        if controller_uuid_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_uuid_ to be a str, received: {}".format(
                    type(controller_uuid_)
                )
            )

        if filename_ is not None and not isinstance(filename_, (bytes, str)):
            raise Exception(
                "Expected filename_ to be a str, received: {}".format(type(filename_))
            )

        if finished_ is not None and not isinstance(finished_, (bytes, str)):
            raise Exception(
                "Expected finished_ to be a str, received: {}".format(type(finished_))
            )

        if format_version_ is not None and not isinstance(format_version_, int):
            raise Exception(
                "Expected format_version_ to be a int, received: {}".format(
        ...
        if ha_nodes_ is not None and not isinstance(ha_nodes_, int):
            raise Exception(
                "Expected ha_nodes_ to be a int, received: {}".format(type(ha_nodes_))
            )

        if hostname_ is not None and not isinstance(hostname_, (bytes, str)):
            raise Exception(
                "Expected hostname_ to be a str, received: {}".format(type(hostname_))
            )
        ...
        if model_ is not None and not isinstance(model_, (bytes, str)):
            raise Exception(
                "Expected model_ to be a str, received: {}".format(type(model_))
            )
        ...
        if size_ is not None and not isinstance(size_, int):
            raise Exception(
                "Expected size_ to be a int, received: {}".format(type(size_))
            )
        ...
        if stored_ is not None and not isinstance(stored_, (bytes, str)):
            raise Exception(
                "Expected stored_ to be a str, received: {}".format(type(stored_))
            )

        if version_ is not None and not isinstance(version_, (dict, Number)):
            raise Exception(
                "Expected version_ to be a Number, received: {}".format(type(version_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if arch_ is not None and not isinstance(arch_, (bytes, str)):
            raise Exception(
                "Expected arch_ to be a str, received: {}".format(type(arch_))
            )

        if build_ is not None and not isinstance(build_, int):
            raise Exception(
                "Expected build_ to be a int, received: {}".format(type(build_))
            )

        if major_ is not None and not isinstance(major_, int):
            raise Exception(
                "Expected major_ to be a int, received: {}".format(type(major_))
            )

        if minor_ is not None and not isinstance(minor_, int):
            raise Exception(
                "Expected minor_ to be a int, received: {}".format(type(minor_))
            )

        if number_ is not None and not isinstance(number_, (dict, Number)):
            raise Exception(
                "Expected number_ to be a Number, received: {}".format(type(number_))
            )

        if patch_ is not None and not isinstance(patch_, int):
            raise Exception(
                "Expected patch_ to be a int, received: {}".format(type(patch_))
            )

        if release_ is not None and not isinstance(release_, (bytes, str)):
            raise Exception(
                "Expected release_ to be a str, received: {}".format(type(release_))
            )
...
class BlockResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, Block)):
            raise Exception(
                "Expected result_ to be a Block, received: {}".format(type(result_))
            )
...
class BoolResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, bool):
            raise Exception(
                "Expected result_ to be a bool, received: {}".format(type(result_))
            )
...
class BranchInfoArgs(Type):
    ...
    def __init__(self, branches=None, detailed=None, **unknown_fields):
        ...
        if branches_ is not None and not isinstance(branches_, (bytes, str, list)):
            raise Exception(
                "Expected branches_ to be a Sequence, received: {}".format(
                    type(branches_)
                )
            )
        ...
        if detailed_ is not None and not isinstance(detailed_, bool):
            raise Exception(
                "Expected detailed_ to be a bool, received: {}".format(type(detailed_))
            )
...
class BranchResults(Type):
    ...
    def __init__(self, error=None, generations=None, **unknown_fields):
        ...
        if generations_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected generations_ to be a Sequence, received: {}".format(
                    type(generations_)
                )
            )
...
class BranchStatus(Type):
    ...
    def __init__(
        ...
        if assigned_units_ is not None and not isinstance(assigned_units_, dict):
            raise Exception(
                "Expected assigned_units_ to be a Mapping, received: {}".format(
                    type(assigned_units_)
                )
            )

        if created_ is not None and not isinstance(created_, int):
            raise Exception(
                "Expected created_ to be a int, received: {}".format(type(created_))
            )

        if created_by_ is not None and not isinstance(created_by_, (bytes, str)):
            raise Exception(
                "Expected created_by_ to be a str, received: {}".format(
                    type(created_by_)
                )
            )
...
class BranchTrackArg(Type):
    ...
    def __init__(self, branch=None, entities=None, num_units=None, **unknown_fields):
        ...
        if entities_ is not None and not isinstance(entities_, (bytes, str, list)):
            raise Exception(
                "Expected entities_ to be a Sequence, received: {}".format(
                    type(entities_)
                )
            )
...
class BulkImportStorageParams(Type):
    ...
    def __init__(self, storage=None, **unknown_fields):
        ...
        if storage_ is not None and not isinstance(storage_, (bytes, str, list)):
            raise Exception(
                "Expected storage_ to be a Sequence, received: {}".format(
                    type(storage_)
                )
            )
...
class BundleChange(Type):
    ...
    def __init__(
        ...
        if method_ is not None and not isinstance(method_, (bytes, str)):
            raise Exception(
                "Expected method_ to be a str, received: {}".format(type(method_))
            )

        if requires_ is not None and not isinstance(requires_, (bytes, str, list)):
            raise Exception(
                "Expected requires_ to be a Sequence, received: {}".format(
                    type(requires_)
                )
            )
...
class BundleChangesMapArgs(Type):
    ...
    def __init__(
        ...
        if args_ is not None and not isinstance(args_, dict):
            raise Exception(
                "Expected args_ to be a Mapping, received: {}".format(type(args_))
            )
...
class BundleChangesMapArgsResults(Type):
    ...
    def __init__(self, changes=None, errors=None, **unknown_fields):
        ...
        if changes_ is not None and not isinstance(changes_, (bytes, str, list)):
            raise Exception(
                "Expected changes_ to be a Sequence, received: {}".format(
                    type(changes_)
                )
            )
        ...
        if errors_ is not None and not isinstance(errors_, (bytes, str, list)):
            raise Exception(
                "Expected errors_ to be a Sequence, received: {}".format(type(errors_))
            )
...
class BundleChangesParams(Type):
    ...
    def __init__(self, bundleurl=None, yaml=None, **unknown_fields):
        ...
        if bundleurl_ is not None and not isinstance(bundleurl_, (bytes, str)):
            raise Exception(
                "Expected bundleurl_ to be a str, received: {}".format(type(bundleurl_))
            )

        if yaml_ is not None and not isinstance(yaml_, (bytes, str)):
            raise Exception(
                "Expected yaml_ to be a str, received: {}".format(type(yaml_))
            )
...
class CIDRParams(Type):
    ...
    def __init__(self, cidrs=None, **unknown_fields):
        ...
        if cidrs_ is not None and not isinstance(cidrs_, (bytes, str, list)):
            raise Exception(
                "Expected cidrs_ to be a Sequence, received: {}".format(type(cidrs_))
            )
...
class ChangeModelCredentialParams(Type):
    ...
    def __init__(self, credential_tag=None, model_tag=None, **unknown_fields):
        ...
        if credential_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected credential_tag_ to be a str, received: {}".format(
                    type(credential_tag_)
                )
            )
...
class ChangeModelCredentialsParams(Type):
    ...
    def __init__(self, model_credentials=None, **unknown_fields):
        ...
        if model_credentials_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected model_credentials_ to be a Sequence, received: {}".format(
                    type(model_credentials_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if actions_ is not None and not isinstance(actions_, (dict, CharmActions)):
            raise Exception(
                "Expected actions_ to be a CharmActions, received: {}".format(
                    type(actions_)
                )
            )
        ...
        if lxd_profile_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected lxd_profile_ to be a CharmLXDProfile, received: {}".format(
                    type(lxd_profile_)
                )
            )
        ...
        if manifest_ is not None and not isinstance(manifest_, (dict, CharmManifest)):
            raise Exception(
                "Expected manifest_ to be a CharmManifest, received: {}".format(
                    type(manifest_)
                )
            )
        ...
        if meta_ is not None and not isinstance(meta_, (dict, CharmMeta)):
            raise Exception(
                "Expected meta_ to be a CharmMeta, received: {}".format(type(meta_))
            )

        if metrics_ is not None and not isinstance(metrics_, (dict, CharmMetrics)):
            raise Exception(
                "Expected metrics_ to be a CharmMetrics, received: {}".format(
                    type(metrics_)
                )
            )
        ...
        if revision_ is not None and not isinstance(revision_, int):
            raise Exception(
                "Expected revision_ to be a int, received: {}".format(type(revision_))
            )
...
class CharmActions(Type):
    ...
    def __init__(self, specs=None, **unknown_fields):
        ...
        if specs_ is not None and not isinstance(specs_, dict):
            raise Exception(
                "Expected specs_ to be a Mapping, received: {}".format(type(specs_))
            )
...
class CharmBase(Type):
    ...
    def __init__(self, architectures=None, channel=None, name=None, **unknown_fields):
        ...
        if architectures_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected architectures_ to be a Sequence, received: {}".format(
                    type(architectures_)
                )
            )
...
class CharmContainer(Type):
    ...
    def __init__(
        ...
        if gid_ is not None and not isinstance(gid_, int):
            raise Exception(
                "Expected gid_ to be a int, received: {}".format(type(gid_))
            )

        if mounts_ is not None and not isinstance(mounts_, (bytes, str, list)):
            raise Exception(
                "Expected mounts_ to be a Sequence, received: {}".format(type(mounts_))
            )

        if resource_ is not None and not isinstance(resource_, (bytes, str)):
            raise Exception(
                "Expected resource_ to be a str, received: {}".format(type(resource_))
            )

        if uid_ is not None and not isinstance(uid_, int):
            raise Exception(
                "Expected uid_ to be a int, received: {}".format(type(uid_))
            )
...
class CharmDeployment(Type):
    ...
    def __init__(
        ...
        if min_version_ is not None and not isinstance(min_version_, (bytes, str)):
            raise Exception(
                "Expected min_version_ to be a str, received: {}".format(
                    type(min_version_)
                )
            )
        ...
        if mode_ is not None and not isinstance(mode_, (bytes, str)):
            raise Exception(
                "Expected mode_ to be a str, received: {}".format(type(mode_))
            )

        if service_ is not None and not isinstance(service_, (bytes, str)):
            raise Exception(
                "Expected service_ to be a str, received: {}".format(type(service_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if countmax_ is not None and not isinstance(countmax_, int):
            raise Exception(
                "Expected countmax_ to be a int, received: {}".format(type(countmax_))
            )

        if countmin_ is not None and not isinstance(countmin_, int):
            raise Exception(
                "Expected countmin_ to be a int, received: {}".format(type(countmin_))
            )
...
class CharmManifest(Type):
    ...
    def __init__(self, bases=None, **unknown_fields):
        ...
        if bases_ is not None and not isinstance(bases_, (bytes, str, list)):
            raise Exception(
                "Expected bases_ to be a Sequence, received: {}".format(type(bases_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if assumes_expr_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected assumes_expr_ to be a ExpressionTree, received: {}".format(
                    type(assumes_expr_)
                )
            )
        ...
        if categories_ is not None and not isinstance(categories_, (bytes, str, list)):
            raise Exception(
                "Expected categories_ to be a Sequence, received: {}".format(
                    type(categories_)
                )
            )
        ...
        if charm_user_ is not None and not isinstance(charm_user_, (bytes, str)):
            raise Exception(
                "Expected charm_user_ to be a str, received: {}".format(
                    type(charm_user_)
                )
            )
        ...
        if containers_ is not None and not isinstance(containers_, dict):
            raise Exception(
                "Expected containers_ to be a Mapping, received: {}".format(
                    type(containers_)
                )
            )
        ...
        if deployment_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected deployment_ to be a CharmDeployment, received: {}".format(
                    type(deployment_)
                )
            )
        ...
        if extra_bindings_ is not None and not isinstance(extra_bindings_, dict):
            raise Exception(
                "Expected extra_bindings_ to be a Mapping, received: {}".format(
                    type(extra_bindings_)
                )
            )
        ...
        if min_juju_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected min_juju_version_ to be a str, received: {}".format(
                    type(min_juju_version_)
                )
            )
        ...
        if payload_classes_ is not None and not isinstance(payload_classes_, dict):
            raise Exception(
                "Expected payload_classes_ to be a Mapping, received: {}".format(
                    type(payload_classes_)
                )
            )

        if peers_ is not None and not isinstance(peers_, dict):
            raise Exception(
                "Expected peers_ to be a Mapping, received: {}".format(type(peers_))
            )

        if provides_ is not None and not isinstance(provides_, dict):
            raise Exception(
                "Expected provides_ to be a Mapping, received: {}".format(
                    type(provides_)
                )
            )
        ...
        if requires_ is not None and not isinstance(requires_, dict):
            raise Exception(
                "Expected requires_ to be a Mapping, received: {}".format(
                    type(requires_)
                )
            )
        ...
        if series_ is not None and not isinstance(series_, (bytes, str, list)):
            raise Exception(
                "Expected series_ to be a Sequence, received: {}".format(type(series_))
            )
        ...
        if subordinate_ is not None and not isinstance(subordinate_, bool):
            raise Exception(
                "Expected subordinate_ to be a bool, received: {}".format(
                    type(subordinate_)
                )
            )
        ...
        if summary_ is not None and not isinstance(summary_, (bytes, str)):
            raise Exception(
                "Expected summary_ to be a str, received: {}".format(type(summary_))
            )

        if tags_ is not None and not isinstance(tags_, (bytes, str, list)):
            raise Exception(
                "Expected tags_ to be a Sequence, received: {}".format(type(tags_))
            )

        if terms_ is not None and not isinstance(terms_, (bytes, str, list)):
            raise Exception(
                "Expected terms_ to be a Sequence, received: {}".format(type(terms_))
            )
...
class CharmMetrics(Type):
    ...
    def __init__(self, metrics=None, plan=None, **unknown_fields):
        ...
        if metrics_ is not None and not isinstance(metrics_, dict):
            raise Exception(
                "Expected metrics_ to be a Mapping, received: {}".format(type(metrics_))
            )

        if plan_ is not None and not isinstance(plan_, (dict, CharmPlan)):
            raise Exception(
                "Expected plan_ to be a CharmPlan, received: {}".format(type(plan_))
            )
...
class CharmMount(Type):
    ...
    def __init__(self, location=None, storage=None, **unknown_fields):
        ...
        if location_ is not None and not isinstance(location_, (bytes, str)):
            raise Exception(
                "Expected location_ to be a str, received: {}".format(type(location_))
            )

        if storage_ is not None and not isinstance(storage_, (bytes, str)):
            raise Exception(
                "Expected storage_ to be a str, received: {}".format(type(storage_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if architecture_ is not None and not isinstance(architecture_, (bytes, str)):
            raise Exception(
                "Expected architecture_ to be a str, received: {}".format(
                    type(architecture_)
                )
            )
        ...
        if hash__ is not None and not isinstance(hash__, (bytes, str)):
            raise Exception(
                "Expected hash__ to be a str, received: {}".format(type(hash__))
            )
        ...
        if instance_key_ is not None and not isinstance(instance_key_, (bytes, str)):
            raise Exception(
                "Expected instance_key_ to be a str, received: {}".format(
                    type(instance_key_)
                )
            )
        ...
        if risk_ is not None and not isinstance(risk_, (bytes, str)):
            raise Exception(
                "Expected risk_ to be a str, received: {}".format(type(risk_))
            )

        if source_ is not None and not isinstance(source_, (bytes, str)):
            raise Exception(
                "Expected source_ to be a str, received: {}".format(type(source_))
            )

        if track_ is not None and not isinstance(track_, (bytes, str)):
            raise Exception(
                "Expected track_ to be a str, received: {}".format(type(track_))
            )
...
class CharmPlan(Type):
    ...
    def __init__(self, required=None, **unknown_fields):
        ...
        if required_ is not None and not isinstance(required_, bool):
            raise Exception(
                "Expected required_ to be a bool, received: {}".format(type(required_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if interface_ is not None and not isinstance(interface_, (bytes, str)):
            raise Exception(
                "Expected interface_ to be a str, received: {}".format(type(interface_))
            )

        if limit_ is not None and not isinstance(limit_, int):
            raise Exception(
                "Expected limit_ to be a int, received: {}".format(type(limit_))
            )
        ...
        if optional_ is not None and not isinstance(optional_, bool):
            raise Exception(
                "Expected optional_ to be a bool, received: {}".format(type(optional_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if fingerprint_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected fingerprint_ to be a Sequence, received: {}".format(
                    type(fingerprint_)
                )
            )
        ...
        if origin_ is not None and not isinstance(origin_, (bytes, str)):
            raise Exception(
                "Expected origin_ to be a str, received: {}".format(type(origin_))
            )

        if path_ is not None and not isinstance(path_, (bytes, str)):
            raise Exception(
                "Expected path_ to be a str, received: {}".format(type(path_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if charmresource_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected charmresource_ to be a CharmResource, received: {}".format(
                    type(charmresource_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if count_max_ is not None and not isinstance(count_max_, int):
            raise Exception(
                "Expected count_max_ to be a int, received: {}".format(type(count_max_))
            )

        if count_min_ is not None and not isinstance(count_min_, int):
            raise Exception(
                "Expected count_min_ to be a int, received: {}".format(type(count_min_))
            )
        ...
        if minimum_size_ is not None and not isinstance(minimum_size_, int):
            raise Exception(
                "Expected minimum_size_ to be a int, received: {}".format(
                    type(minimum_size_)
                )
            )
        ...
        if properties_ is not None and not isinstance(properties_, (bytes, str, list)):
            raise Exception(
                "Expected properties_ to be a Sequence, received: {}".format(
                    type(properties_)
                )
            )
        ...
        if read_only_ is not None and not isinstance(read_only_, bool):
            raise Exception(
                "Expected read_only_ to be a bool, received: {}".format(
                    type(read_only_)
                )
            )
        ...
        if shared_ is not None and not isinstance(shared_, bool):
            raise Exception(
                "Expected shared_ to be a bool, received: {}".format(type(shared_))
            )
...
class CharmsList(Type):
    ...
    def __init__(self, names=None, **unknown_fields):
        ...
        if names_ is not None and not isinstance(names_, (bytes, str, list)):
            raise Exception(
                "Expected names_ to be a Sequence, received: {}".format(type(names_))
            )
...
class CharmsListResult(Type):
    ...
    def __init__(self, charm_urls=None, **unknown_fields):
        ...
        if charm_urls_ is not None and not isinstance(charm_urls_, (bytes, str, list)):
            raise Exception(
                "Expected charm_urls_ to be a Sequence, received: {}".format(
                    type(charm_urls_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if auth_types_ is not None and not isinstance(auth_types_, (bytes, str, list)):
            raise Exception(
                "Expected auth_types_ to be a Sequence, received: {}".format(
                    type(auth_types_)
                )
            )
        ...
        if ca_certificates_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected ca_certificates_ to be a Sequence, received: {}".format(
                    type(ca_certificates_)
                )
            )
        ...
        if endpoint_ is not None and not isinstance(endpoint_, (bytes, str)):
            raise Exception(
                "Expected endpoint_ to be a str, received: {}".format(type(endpoint_))
            )
        ...
        if host_cloud_region_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected host_cloud_region_ to be a str, received: {}".format(
                    type(host_cloud_region_)
                )
            )
        ...
        if identity_endpoint_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected identity_endpoint_ to be a str, received: {}".format(
                    type(identity_endpoint_)
                )
            )
        ...
        if is_controller_cloud_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected is_controller_cloud_ to be a bool, received: {}".format(
                    type(is_controller_cloud_)
                )
            )

        if region_config_ is not None and not isinstance(region_config_, dict):
            raise Exception(
                "Expected region_config_ to be a Mapping, received: {}".format(
                    type(region_config_)
                )
            )
        ...
        if regions_ is not None and not isinstance(regions_, (bytes, str, list)):
            raise Exception(
                "Expected regions_ to be a Sequence, received: {}".format(
                    type(regions_)
                )
            )
        ...
        if skip_tls_verify_ is not None and not isinstance(skip_tls_verify_, bool):
            raise Exception(
                "Expected skip_tls_verify_ to be a bool, received: {}".format(
                    type(skip_tls_verify_)
                )
            )
        ...
        if storage_endpoint_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_endpoint_ to be a str, received: {}".format(
                    type(storage_endpoint_)
                )
            )
...
class CloudCredential(Type):
    ...
    def __init__(self, attrs=None, auth_type=None, redacted=None, **unknown_fields):
        ...
        if attrs_ is not None and not isinstance(attrs_, dict):
            raise Exception(
                "Expected attrs_ to be a Mapping, received: {}".format(type(attrs_))
            )

        if auth_type_ is not None and not isinstance(auth_type_, (bytes, str)):
            raise Exception(
                "Expected auth_type_ to be a str, received: {}".format(type(auth_type_))
            )

        if redacted_ is not None and not isinstance(redacted_, (bytes, str, list)):
            raise Exception(
                "Expected redacted_ to be a Sequence, received: {}".format(
                    type(redacted_)
                )
            )
...
class CloudCredentialArg(Type):
    ...
    def __init__(self, cloud_name=None, credential_name=None, **unknown_fields):
        ...
        if cloud_name_ is not None and not isinstance(cloud_name_, (bytes, str)):
            raise Exception(
                "Expected cloud_name_ to be a str, received: {}".format(
                    type(cloud_name_)
                )
            )
        ...
        if credential_name_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected credential_name_ to be a str, received: {}".format(
                    type(credential_name_)
                )
            )
...
class CloudCredentialArgs(Type):
    ...
    def __init__(self, credentials=None, include_secrets=None, **unknown_fields):
        ...
        if credentials_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected credentials_ to be a Sequence, received: {}".format(
                    type(credentials_)
                )
            )
        ...
        if include_secrets_ is not None and not isinstance(include_secrets_, bool):
            raise Exception(
                "Expected include_secrets_ to be a bool, received: {}".format(
                    type(include_secrets_)
                )
            )
...
class CloudCredentialResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, CloudCredential)):
            raise Exception(
                "Expected result_ to be a CloudCredential, received: {}".format(
                    type(result_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if image_id_ is not None and not isinstance(image_id_, (bytes, str)):
            raise Exception(
                "Expected image_id_ to be a str, received: {}".format(type(image_id_))
            )

        if priority_ is not None and not isinstance(priority_, int):
            raise Exception(
                "Expected priority_ to be a int, received: {}".format(type(priority_))
            )

        if region_ is not None and not isinstance(region_, (bytes, str)):
            raise Exception(
                "Expected region_ to be a str, received: {}".format(type(region_))
            )

        if root_storage_size_ is not None and not isinstance(root_storage_size_, int):
            raise Exception(
                "Expected root_storage_size_ to be a int, received: {}".format(
                    type(root_storage_size_)
                )
            )
        ...
        if root_storage_type_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected root_storage_type_ to be a str, received: {}".format(
                    type(root_storage_type_)
                )
            )
        ...
        if stream_ is not None and not isinstance(stream_, (bytes, str)):
            raise Exception(
                "Expected stream_ to be a str, received: {}".format(type(stream_))
            )

        if version_ is not None and not isinstance(version_, (bytes, str)):
            raise Exception(
                "Expected version_ to be a str, received: {}".format(type(version_))
            )

        if virt_type_ is not None and not isinstance(virt_type_, (bytes, str)):
            raise Exception(
                "Expected virt_type_ to be a str, received: {}".format(type(virt_type_))
            )
...
class CloudImageMetadataList(Type):
    ...
    def __init__(self, metadata=None, **unknown_fields):
        ...
        if metadata_ is not None and not isinstance(metadata_, (bytes, str, list)):
            raise Exception(
                "Expected metadata_ to be a Sequence, received: {}".format(
                    type(metadata_)
                )
            )
...
class CloudInfo(Type):
    ...
    def __init__(self, clouddetails=None, users=None, **unknown_fields):
        ...
        if clouddetails_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected clouddetails_ to be a CloudDetails, received: {}".format(
                    type(clouddetails_)
                )
            )
...
class CloudInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, CloudInfo)):
            raise Exception(
                "Expected result_ to be a CloudInfo, received: {}".format(type(result_))
            )
...
class CloudInstanceTypesConstraint(Type):
    ...
    def __init__(self, cloud_tag=None, constraints=None, region=None, **unknown_fields):
        ...
        if cloud_tag_ is not None and not isinstance(cloud_tag_, (bytes, str)):
            raise Exception(
                "Expected cloud_tag_ to be a str, received: {}".format(type(cloud_tag_))
            )
...
class CloudInstanceTypesConstraints(Type):
    ...
    def __init__(self, constraints=None, **unknown_fields):
        ...
        if constraints_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected constraints_ to be a Sequence, received: {}".format(
                    type(constraints_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cacertificates_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected cacertificates_ to be a Sequence, received: {}".format(
                    type(cacertificates_)
                )
            )
        ...
        if credential_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected credential_ to be a CloudCredential, received: {}".format(
                    type(credential_)
                )
            )
...
class CloudSpecResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, CloudSpec)):
            raise Exception(
                "Expected result_ to be a CloudSpec, received: {}".format(type(result_))
            )
...
class CloudUserInfo(Type):
    ...
    def __init__(self, access=None, display_name=None, user=None, **unknown_fields):
        ...
        if access_ is not None and not isinstance(access_, (bytes, str)):
            raise Exception(
                "Expected access_ to be a str, received: {}".format(type(access_))
            )
        ...
        if user_ is not None and not isinstance(user_, (bytes, str)):
            raise Exception(
                "Expected user_ to be a str, received: {}".format(type(user_))
            )
...
class CloudsResult(Type):
    ...
    def __init__(self, clouds=None, **unknown_fields):
        ...
        if clouds_ is not None and not isinstance(clouds_, dict):
            raise Exception(
                "Expected clouds_ to be a Mapping, received: {}".format(type(clouds_))
            )
...
class Constraints(Type):
    ...
    def __init__(self, count=None, pool=None, size=None, **unknown_fields):
        ...
        if count_ is not None and not isinstance(count_, int):
            raise Exception(
                "Expected count_ to be a int, received: {}".format(type(count_))
            )

        if pool_ is not None and not isinstance(pool_, (bytes, str)):
            raise Exception(
                "Expected pool_ to be a str, received: {}".format(type(pool_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if application_alias_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_alias_ to be a str, received: {}".format(
                    type(application_alias_)
                )
            )
        ...
        if external_controller_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected external_controller_ to be a ExternalControllerInfo, received: {}".format(
                    type(external_controller_)
                )
            )
...
class ConsumeOfferDetails(Type):
    ...
    def __init__(
        ...
        if offer_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected offer_ to be a ApplicationOfferDetailsV5, received: {}".format(
                    type(offer_)
                )
            )
...
class ConsumeOfferDetailsArg(Type):
    ...
    def __init__(self, offer_urls=None, user_tag=None, **unknown_fields):
        ...
        if offer_urls_ is not None and not isinstance(offer_urls_, (dict, OfferURLs)):
            raise Exception(
                "Expected offer_urls_ to be a OfferURLs, received: {}".format(
                    type(offer_urls_)
                )
            )
        ...
        if user_tag_ is not None and not isinstance(user_tag_, (bytes, str)):
            raise Exception(
                "Expected user_tag_ to be a str, received: {}".format(type(user_tag_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if consumeofferdetails_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected consumeofferdetails_ to be a ConsumeOfferDetails, received: {}".format(
                    type(consumeofferdetails_)
                )
            )
...
class ControllerAPIInfoResult(Type):
    ...
    def __init__(self, addresses=None, cacert=None, error=None, **unknown_fields):
        ...
        if cacert_ is not None and not isinstance(cacert_, (bytes, str)):
            raise Exception(
                "Expected cacert_ to be a str, received: {}".format(type(cacert_))
            )
...
class ControllerCredentialInfo(Type):
    ...
    def __init__(self, content=None, models=None, **unknown_fields):
        ...
        if content_ is not None and not isinstance(content_, (dict, CredentialContent)):
            raise Exception(
                "Expected content_ to be a CredentialContent, received: {}".format(
                    type(content_)
                )
            )
        ...
        if models_ is not None and not isinstance(models_, (bytes, str, list)):
            raise Exception(
                "Expected models_ to be a Sequence, received: {}".format(type(models_))
            )
...
class ControllerVersionResults(Type):
    ...
    def __init__(self, git_commit=None, version=None, **unknown_fields):
        ...
        if git_commit_ is not None and not isinstance(git_commit_, (bytes, str)):
            raise Exception(
                "Expected git_commit_ to be a str, received: {}".format(
                    type(git_commit_)
                )
            )
...
class ControllersChangeResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ControllersChanges)):
            raise Exception(
                "Expected result_ to be a ControllersChanges, received: {}".format(
                    type(result_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if added_ is not None and not isinstance(added_, (bytes, str, list)):
            raise Exception(
                "Expected added_ to be a Sequence, received: {}".format(type(added_))
            )

        if converted_ is not None and not isinstance(converted_, (bytes, str, list)):
            raise Exception(
                "Expected converted_ to be a Sequence, received: {}".format(
                    type(converted_)
                )
            )
        ...
        if maintained_ is not None and not isinstance(maintained_, (bytes, str, list)):
            raise Exception(
                "Expected maintained_ to be a Sequence, received: {}".format(
                    type(maintained_)
                )
            )
        ...
        if removed_ is not None and not isinstance(removed_, (bytes, str, list)):
            raise Exception(
                "Expected removed_ to be a Sequence, received: {}".format(
                    type(removed_)
                )
            )
...
class ControllersSpec(Type):
    ...
    def __init__(
        ...
        if num_controllers_ is not None and not isinstance(num_controllers_, int):
            raise Exception(
                "Expected num_controllers_ to be a int, received: {}".format(
                    type(num_controllers_)
                )
            )
...
class ControllersSpecs(Type):
    ...
    def __init__(self, specs=None, **unknown_fields):
        ...
        if specs_ is not None and not isinstance(specs_, (bytes, str, list)):
            raise Exception(
                "Expected specs_ to be a Sequence, received: {}".format(type(specs_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if upsertsecretarg_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected upsertsecretarg_ to be a UpsertSecretArg, received: {}".format(
                    type(upsertsecretarg_)
                )
            )
        ...
        if content_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected content_ to be a SecretContentParams, received: {}".format(
                    type(content_)
                )
            )
        ...
        if expire_time_ is not None and not isinstance(expire_time_, (bytes, str)):
            raise Exception(
                "Expected expire_time_ to be a str, received: {}".format(
                    type(expire_time_)
                )
            )
        ...
        if label_ is not None and not isinstance(label_, (bytes, str)):
            raise Exception(
                "Expected label_ to be a str, received: {}".format(type(label_))
            )
        ...
        if rotate_policy_ is not None and not isinstance(rotate_policy_, (bytes, str)):
            raise Exception(
                "Expected rotate_policy_ to be a str, received: {}".format(
                    type(rotate_policy_)
                )
            )
        ...
        if uri_ is not None and not isinstance(uri_, (bytes, str)):
            raise Exception(
                "Expected uri_ to be a str, received: {}".format(type(uri_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if public_ is not None and not isinstance(public_, bool):
            raise Exception(
                "Expected public_ to be a bool, received: {}".format(type(public_))
            )

        if space_tag_ is not None and not isinstance(space_tag_, (bytes, str)):
            raise Exception(
                "Expected space_tag_ to be a str, received: {}".format(type(space_tag_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cloud_ is not None and not isinstance(cloud_, (bytes, str)):
            raise Exception(
                "Expected cloud_ to be a str, received: {}".format(type(cloud_))
            )
        ...
        if valid_ is not None and not isinstance(valid_, bool):
            raise Exception(
                "Expected valid_ to be a bool, received: {}".format(type(valid_))
            )
...
class CredentialContentResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected result_ to be a ControllerCredentialInfo, received: {}".format(
                    type(result_)
                )
            )
...
class DashboardConnectionInfo(Type):
    ...
    def __init__(
        ...
        if proxy_connection_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected proxy_connection_ to be a Proxy, received: {}".format(
                    type(proxy_connection_)
                )
            )
        ...
        if ssh_connection_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected ssh_connection_ to be a DashboardConnectionSSHTunnel, received: {}".format(
                    type(ssh_connection_)
                )
            )
...
class DashboardConnectionSSHTunnel(Type):
    ...
    def __init__(self, entity=None, host=None, model=None, port=None, **unknown_fields):
        ...
        if host_ is not None and not isinstance(host_, (bytes, str)):
            raise Exception(
                "Expected host_ to be a str, received: {}".format(type(host_))
            )
        ...
        if port_ is not None and not isinstance(port_, (bytes, str)):
            raise Exception(
                "Expected port_ to be a str, received: {}".format(type(port_))
            )
...
class DeleteSecretArg(Type):
    ...
    def __init__(self, label=None, revisions=None, uri=None, **unknown_fields):
        ...
        if revisions_ is not None and not isinstance(revisions_, (bytes, str, list)):
            raise Exception(
                "Expected revisions_ to be a Sequence, received: {}".format(
                    type(revisions_)
                )
            )
...
class Delta(Type):
    ...
    def __init__(self, entity=None, removed=None, **unknown_fields):
        ...
        if removed_ is not None and not isinstance(removed_, bool):
            raise Exception(
                "Expected removed_ to be a bool, received: {}".format(type(removed_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if applicationname_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected applicationname_ to be a str, received: {}".format(
                    type(applicationname_)
                )
            )
        ...
        if attachstorage_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected attachstorage_ to be a Sequence, received: {}".format(
                    type(attachstorage_)
                )
            )
        ...
        if charmname_ is not None and not isinstance(charmname_, (bytes, str)):
            raise Exception(
                "Expected charmname_ to be a str, received: {}".format(type(charmname_))
            )

        if configyaml_ is not None and not isinstance(configyaml_, (bytes, str)):
            raise Exception(
                "Expected configyaml_ to be a str, received: {}".format(
                    type(configyaml_)
                )
            )
        ...
        if cons_ is not None and not isinstance(cons_, (dict, Value)):
            raise Exception(
                "Expected cons_ to be a Value, received: {}".format(type(cons_))
            )
        ...
        if dryrun_ is not None and not isinstance(dryrun_, bool):
            raise Exception(
                "Expected dryrun_ to be a bool, received: {}".format(type(dryrun_))
            )
        ...
        if trust_ is not None and not isinstance(trust_, bool):
            raise Exception(
                "Expected trust_ to be a bool, received: {}".format(type(trust_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if effective_channel_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected effective_channel_ to be a str, received: {}".format(
                    type(effective_channel_)
                )
            )
...
class DeployFromRepositoryResult(Type):
    ...
    def __init__(
        ...
        if info_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected info_ to be a DeployFromRepositoryInfo, received: {}".format(
                    type(info_)
                )
            )
        ...
        if pendingresourceuploads_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected pendingresourceuploads_ to be a Sequence, received: {}".format(
                    type(pendingresourceuploads_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if destroyed_storage_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected destroyed_storage_ to be a Sequence, received: {}".format(
                    type(destroyed_storage_)
                )
            )
        ...
        if destroyed_units_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected destroyed_units_ to be a Sequence, received: {}".format(
                    type(destroyed_units_)
                )
            )
        ...
        if detached_storage_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected detached_storage_ to be a Sequence, received: {}".format(
                    type(detached_storage_)
                )
            )
...
class DestroyApplicationOffers(Type):
    ...
    def __init__(self, force=None, offer_urls=None, **unknown_fields):
        ...
        if offer_urls_ is not None and not isinstance(offer_urls_, (bytes, str, list)):
            raise Exception(
                "Expected offer_urls_ to be a Sequence, received: {}".format(
                    type(offer_urls_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if destroy_storage_ is not None and not isinstance(destroy_storage_, bool):
            raise Exception(
                "Expected destroy_storage_ to be a bool, received: {}".format(
                    type(destroy_storage_)
                )
            )

        if dry_run_ is not None and not isinstance(dry_run_, bool):
            raise Exception(
                "Expected dry_run_ to be a bool, received: {}".format(type(dry_run_))
            )
        ...
        if max_wait_ is not None and not isinstance(max_wait_, int):
            raise Exception(
                "Expected max_wait_ to be a int, received: {}".format(type(max_wait_))
            )
...
class DestroyApplicationResult(Type):
    ...
    def __init__(self, error=None, info=None, **unknown_fields):
        ...
        if info_ is not None and not isinstance(info_, (dict, DestroyApplicationInfo)):
            raise Exception(
                "Expected info_ to be a DestroyApplicationInfo, received: {}".format(
                    type(info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if destroy_models_ is not None and not isinstance(destroy_models_, bool):
            raise Exception(
                "Expected destroy_models_ to be a bool, received: {}".format(
                    type(destroy_models_)
                )
            )
        ...
        if model_timeout_ is not None and not isinstance(model_timeout_, int):
            raise Exception(
                "Expected model_timeout_ to be a int, received: {}".format(
                    type(model_timeout_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if destroyed_containers_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected destroyed_containers_ to be a Sequence, received: {}".format(
                    type(destroyed_containers_)
                )
            )
        ...
        if machine_id_ is not None and not isinstance(machine_id_, (bytes, str)):
            raise Exception(
                "Expected machine_id_ to be a str, received: {}".format(
                    type(machine_id_)
                )
            )
...
class DestroyMachineResult(Type):
    ...
    def __init__(self, error=None, info=None, **unknown_fields):
        ...
        if info_ is not None and not isinstance(info_, (dict, DestroyMachineInfo)):
            raise Exception(
                "Expected info_ to be a DestroyMachineInfo, received: {}".format(
                    type(info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if keep_ is not None and not isinstance(keep_, bool):
            raise Exception(
                "Expected keep_ to be a bool, received: {}".format(type(keep_))
            )
        ...
        if machine_tags_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected machine_tags_ to be a Sequence, received: {}".format(
                    type(machine_tags_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if timeout_ is not None and not isinstance(timeout_, int):
            raise Exception(
                "Expected timeout_ to be a int, received: {}".format(type(timeout_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if relation_id_ is not None and not isinstance(relation_id_, int):
            raise Exception(
                "Expected relation_id_ to be a int, received: {}".format(
                    type(relation_id_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if unit_tag_ is not None and not isinstance(unit_tag_, (bytes, str)):
            raise Exception(
                "Expected unit_tag_ to be a str, received: {}".format(type(unit_tag_))
            )
...
class DestroyUnitResult(Type):
    ...
    def __init__(self, error=None, info=None, **unknown_fields):
        ...
        if info_ is not None and not isinstance(info_, (dict, DestroyUnitInfo)):
            raise Exception(
                "Expected info_ to be a DestroyUnitInfo, received: {}".format(
                    type(info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if data_ is not None and not isinstance(data_, dict):
            raise Exception(
                "Expected data_ to be a Mapping, received: {}".format(type(data_))
            )
        ...
        if info_ is not None and not isinstance(info_, (bytes, str)):
            raise Exception(
                "Expected info_ to be a str, received: {}".format(type(info_))
            )

        if kind_ is not None and not isinstance(kind_, (bytes, str)):
            raise Exception(
                "Expected kind_ to be a str, received: {}".format(type(kind_))
            )
        ...
        if since_ is not None and not isinstance(since_, (bytes, str)):
            raise Exception(
                "Expected since_ to be a str, received: {}".format(type(since_))
            )
...
class DumpModelRequest(Type):
    ...
    def __init__(self, entities=None, simplified=None, **unknown_fields):
        ...
        if simplified_ is not None and not isinstance(simplified_, bool):
            raise Exception(
                "Expected simplified_ to be a bool, received: {}".format(
                    type(simplified_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if applicationdata_ is not None and not isinstance(applicationdata_, dict):
            raise Exception(
                "Expected applicationdata_ to be a Mapping, received: {}".format(
                    type(applicationdata_)
                )
            )

        if cross_model_ is not None and not isinstance(cross_model_, bool):
            raise Exception(
                "Expected cross_model_ to be a bool, received: {}".format(
                    type(cross_model_)
                )
            )
        ...
        if related_endpoint_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected related_endpoint_ to be a str, received: {}".format(
                    type(related_endpoint_)
                )
            )
        ...
        if unit_relation_data_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected unit_relation_data_ to be a Mapping, received: {}".format(
                    type(unit_relation_data_)
                )
            )
...
class EnqueuedActions(Type):
    ...
    def __init__(self, actions=None, operation=None, **unknown_fields):
        ...
        if operation_ is not None and not isinstance(operation_, (bytes, str)):
            raise Exception(
                "Expected operation_ to be a str, received: {}".format(type(operation_))
            )
...
class EntityMetrics(Type):
    ...
    def __init__(self, error=None, metrics=None, **unknown_fields):
        ...
        if metrics_ is not None and not isinstance(metrics_, (bytes, str, list)):
            raise Exception(
                "Expected metrics_ to be a Sequence, received: {}".format(
                    type(metrics_)
                )
            )
...
class Error(Type):
    ...
    def __init__(self, code=None, info=None, message=None, **unknown_fields):
        ...
        if code_ is not None and not isinstance(code_, (bytes, str)):
            raise Exception(
                "Expected code_ to be a str, received: {}".format(type(code_))
            )

        if info_ is not None and not isinstance(info_, dict):
            raise Exception(
                "Expected info_ to be a Mapping, received: {}".format(type(info_))
            )
...
class ExportBundleParams(Type):
    ...
    def __init__(
        ...
        if include_charm_defaults_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected include_charm_defaults_ to be a bool, received: {}".format(
                    type(include_charm_defaults_)
                )
            )

        if include_series_ is not None and not isinstance(include_series_, bool):
            raise Exception(
                "Expected include_series_ to be a bool, received: {}".format(
                    type(include_series_)
                )
            )
...
class ExposedEndpoint(Type):
    ...
    def __init__(self, expose_to_cidrs=None, expose_to_spaces=None, **unknown_fields):
        ...
        if expose_to_cidrs_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected expose_to_cidrs_ to be a Sequence, received: {}".format(
                    type(expose_to_cidrs_)
                )
            )
        ...
        if expose_to_spaces_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected expose_to_spaces_ to be a Sequence, received: {}".format(
                    type(expose_to_spaces_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if addrs_ is not None and not isinstance(addrs_, (bytes, str, list)):
            raise Exception(
                "Expected addrs_ to be a Sequence, received: {}".format(type(addrs_))
            )

        if ca_cert_ is not None and not isinstance(ca_cert_, (bytes, str)):
            raise Exception(
                "Expected ca_cert_ to be a str, received: {}".format(type(ca_cert_))
            )
        ...
        if controller_alias_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_alias_ to be a str, received: {}".format(
                    type(controller_alias_)
                )
            )
        ...
        if controller_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_tag_ to be a str, received: {}".format(
                    type(controller_tag_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if filesystemattachmentinfo_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected filesystemattachmentinfo_ to be a FilesystemAttachmentInfo, received: {}".format(
                    type(filesystemattachmentinfo_)
                )
            )
        ...
        if mount_point_ is not None and not isinstance(mount_point_, (bytes, str)):
            raise Exception(
                "Expected mount_point_ to be a str, received: {}".format(
                    type(mount_point_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if filesystem_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected filesystem_tag_ to be a str, received: {}".format(
                    type(filesystem_tag_)
                )
            )

        if info_ is not None and not isinstance(info_, (dict, FilesystemInfo)):
            raise Exception(
                "Expected info_ to be a FilesystemInfo, received: {}".format(
                    type(info_)
                )
            )
        ...
        if machine_attachments_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected machine_attachments_ to be a Mapping, received: {}".format(
                    type(machine_attachments_)
                )
            )

        if status_ is not None and not isinstance(status_, (dict, EntityStatus)):
            raise Exception(
                "Expected status_ to be a EntityStatus, received: {}".format(
                    type(status_)
                )
            )
        ...
        if storage_ is not None and not isinstance(storage_, (dict, StorageDetails)):
            raise Exception(
                "Expected storage_ to be a StorageDetails, received: {}".format(
                    type(storage_)
                )
            )
        ...
        if unit_attachments_ is not None and not isinstance(unit_attachments_, dict):
            raise Exception(
                "Expected unit_attachments_ to be a Mapping, received: {}".format(
                    type(unit_attachments_)
                )
            )

        if volume_tag_ is not None and not isinstance(volume_tag_, (bytes, str)):
            raise Exception(
                "Expected volume_tag_ to be a str, received: {}".format(
                    type(volume_tag_)
                )
            )
...
class FilesystemDetailsListResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (bytes, str, list)):
            raise Exception(
                "Expected result_ to be a Sequence, received: {}".format(type(result_))
            )
...
class FilesystemFilters(Type):
    ...
    def __init__(self, filters=None, **unknown_fields):
        ...
        if filters_ is not None and not isinstance(filters_, (bytes, str, list)):
            raise Exception(
                "Expected filters_ to be a Sequence, received: {}".format(
                    type(filters_)
                )
            )
...
class FilesystemInfo(Type):
    ...
    def __init__(self, filesystem_id=None, pool=None, size=None, **unknown_fields):
        ...
        if filesystem_id_ is not None and not isinstance(filesystem_id_, (bytes, str)):
            raise Exception(
                "Expected filesystem_id_ to be a str, received: {}".format(
                    type(filesystem_id_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if agentstream_ is not None and not isinstance(agentstream_, (bytes, str)):
            raise Exception(
                "Expected agentstream_ to be a str, received: {}".format(
                    type(agentstream_)
                )
            )
        ...
        if os_type_ is not None and not isinstance(os_type_, (bytes, str)):
            raise Exception(
                "Expected os_type_ to be a str, received: {}".format(type(os_type_))
            )
...
class FindToolsResult(Type):
    ...
    def __init__(self, error=None, list_=None, **unknown_fields):
        ...
        if list__ is not None and not isinstance(list__, (bytes, str, list)):
            raise Exception(
                "Expected list__ to be a Sequence, received: {}".format(type(list__))
            )
...
class FirewallRule(Type):
    ...
    def __init__(self, known_service=None, whitelist_cidrs=None, **unknown_fields):
        ...
        if known_service_ is not None and not isinstance(known_service_, (bytes, str)):
            raise Exception(
                "Expected known_service_ to be a str, received: {}".format(
                    type(known_service_)
                )
            )
        ...
        if whitelist_cidrs_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected whitelist_cidrs_ to be a Sequence, received: {}".format(
                    type(whitelist_cidrs_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if applications_ is not None and not isinstance(applications_, dict):
            raise Exception(
                "Expected applications_ to be a Mapping, received: {}".format(
                    type(applications_)
                )
            )
        ...
        if branches_ is not None and not isinstance(branches_, dict):
            raise Exception(
                "Expected branches_ to be a Mapping, received: {}".format(
                    type(branches_)
                )
            )
        ...
        if controller_timestamp_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_timestamp_ to be a str, received: {}".format(
                    type(controller_timestamp_)
                )
            )
        ...
        if filesystems_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected filesystems_ to be a Sequence, received: {}".format(
                    type(filesystems_)
                )
            )
        ...
        if machines_ is not None and not isinstance(machines_, dict):
            raise Exception(
                "Expected machines_ to be a Mapping, received: {}".format(
                    type(machines_)
                )
            )
        ...
        if model_ is not None and not isinstance(model_, (dict, ModelStatusInfo)):
            raise Exception(
                "Expected model_ to be a ModelStatusInfo, received: {}".format(
                    type(model_)
                )
            )
        ...
        if offers_ is not None and not isinstance(offers_, dict):
            raise Exception(
                "Expected offers_ to be a Mapping, received: {}".format(type(offers_))
            )

        if relations_ is not None and not isinstance(relations_, (bytes, str, list)):
            raise Exception(
                "Expected relations_ to be a Sequence, received: {}".format(
                    type(relations_)
                )
            )
        ...
        if remote_applications_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected remote_applications_ to be a Mapping, received: {}".format(
                    type(remote_applications_)
                )
            )
        ...
        if volumes_ is not None and not isinstance(volumes_, (bytes, str, list)):
            raise Exception(
                "Expected volumes_ to be a Sequence, received: {}".format(
                    type(volumes_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if completed_ is not None and not isinstance(completed_, int):
            raise Exception(
                "Expected completed_ to be a int, received: {}".format(type(completed_))
            )

        if completed_by_ is not None and not isinstance(completed_by_, (bytes, str)):
            raise Exception(
                "Expected completed_by_ to be a str, received: {}".format(
                    type(completed_by_)
                )
            )
        ...
        if generation_id_ is not None and not isinstance(generation_id_, int):
            raise Exception(
                "Expected generation_id_ to be a int, received: {}".format(
                    type(generation_id_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if pending_ is not None and not isinstance(pending_, (bytes, str, list)):
            raise Exception(
                "Expected pending_ to be a Sequence, received: {}".format(
                    type(pending_)
                )
            )
        ...
        if progress_ is not None and not isinstance(progress_, (bytes, str)):
            raise Exception(
                "Expected progress_ to be a str, received: {}".format(type(progress_))
            )

        if tracking_ is not None and not isinstance(tracking_, (bytes, str, list)):
            raise Exception(
                "Expected tracking_ to be a Sequence, received: {}".format(
                    type(tracking_)
                )
            )
...
class GenerationResult(Type):
    ...
    def __init__(self, error=None, generation=None, **unknown_fields):
        ...
        if generation_ is not None and not isinstance(generation_, (dict, Generation)):
            raise Exception(
                "Expected generation_ to be a Generation, received: {}".format(
                    type(generation_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if availability_zone_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected availability_zone_ to be a str, received: {}".format(
                    type(availability_zone_)
                )
            )

        if cpu_cores_ is not None and not isinstance(cpu_cores_, int):
            raise Exception(
                "Expected cpu_cores_ to be a int, received: {}".format(type(cpu_cores_))
            )

        if cpu_power_ is not None and not isinstance(cpu_power_, int):
            raise Exception(
                "Expected cpu_power_ to be a int, received: {}".format(type(cpu_power_))
            )

        if mem_ is not None and not isinstance(mem_, int):
            raise Exception(
                "Expected mem_ to be a int, received: {}".format(type(mem_))
            )

        if root_disk_ is not None and not isinstance(root_disk_, int):
            raise Exception(
                "Expected root_disk_ to be a int, received: {}".format(type(root_disk_))
            )
        ...
        if root_disk_source_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected root_disk_source_ to be a str, received: {}".format(
                    type(root_disk_source_)
                )
            )
...
class History(Type):
    ...
    def __init__(self, error=None, statuses=None, **unknown_fields):
        ...
        if statuses_ is not None and not isinstance(statuses_, (bytes, str, list)):
            raise Exception(
                "Expected statuses_ to be a Sequence, received: {}".format(
                    type(statuses_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if address_ is not None and not isinstance(address_, (dict, Address)):
            raise Exception(
                "Expected address_ to be a Address, received: {}".format(type(address_))
            )
        ...
        if port_ is not None and not isinstance(port_, int):
            raise Exception(
                "Expected port_ to be a int, received: {}".format(type(port_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cloud_spec_ is not None and not isinstance(cloud_spec_, (dict, CloudSpec)):
            raise Exception(
                "Expected cloud_spec_ to be a CloudSpec, received: {}".format(
                    type(cloud_spec_)
                )
            )
        ...
        if owner_ is not None and not isinstance(owner_, (bytes, str)):
            raise Exception(
                "Expected owner_ to be a str, received: {}".format(type(owner_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if arches_ is not None and not isinstance(arches_, (bytes, str, list)):
            raise Exception(
                "Expected arches_ to be a Sequence, received: {}".format(type(arches_))
            )
        ...
        if versions_ is not None and not isinstance(versions_, (bytes, str, list)):
            raise Exception(
                "Expected versions_ to be a Sequence, received: {}".format(
                    type(versions_)
                )
            )
...
class ImportStorageDetails(Type):
    ...
    def __init__(self, storage_tag=None, **unknown_fields):
        ...
        if storage_tag_ is not None and not isinstance(storage_tag_, (bytes, str)):
            raise Exception(
                "Expected storage_tag_ to be a str, received: {}".format(
                    type(storage_tag_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if kind_ is not None and not isinstance(kind_, int):
            raise Exception(
                "Expected kind_ to be a int, received: {}".format(type(kind_))
            )
        ...
        if storage_name_ is not None and not isinstance(storage_name_, (bytes, str)):
            raise Exception(
                "Expected storage_name_ to be a str, received: {}".format(
                    type(storage_name_)
                )
            )
...
class ImportStorageResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected result_ to be a ImportStorageDetails, received: {}".format(
                    type(result_)
                )
            )
...
class InitiateMigrationResult(Type):
    ...
    def __init__(self, error=None, migration_id=None, model_tag=None, **unknown_fields):
        ...
        if migration_id_ is not None and not isinstance(migration_id_, (bytes, str)):
            raise Exception(
                "Expected migration_id_ to be a str, received: {}".format(
                    type(migration_id_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cost_ is not None and not isinstance(cost_, int):
            raise Exception(
                "Expected cost_ to be a int, received: {}".format(type(cost_))
            )
        ...
        if memory_ is not None and not isinstance(memory_, int):
            raise Exception(
                "Expected memory_ to be a int, received: {}".format(type(memory_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cost_currency_ is not None and not isinstance(cost_currency_, (bytes, str)):
            raise Exception(
                "Expected cost_currency_ to be a str, received: {}".format(
                    type(cost_currency_)
                )
            )
        ...
        if cost_divisor_ is not None and not isinstance(cost_divisor_, int):
            raise Exception(
                "Expected cost_divisor_ to be a int, received: {}".format(
                    type(cost_divisor_)
                )
            )
        ...
        if cost_unit_ is not None and not isinstance(cost_unit_, (bytes, str)):
            raise Exception(
                "Expected cost_unit_ to be a str, received: {}".format(type(cost_unit_))
            )
        ...
        if instance_types_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected instance_types_ to be a Sequence, received: {}".format(
                    type(instance_types_)
                )
            )
...
class IntResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, int):
            raise Exception(
                "Expected result_ to be a int, received: {}".format(type(result_))
            )
...
class InvalidateCredentialArg(Type):
    ...
    def __init__(self, reason=None, **unknown_fields):
        ...
        if reason_ is not None and not isinstance(reason_, (bytes, str)):
            raise Exception(
                "Expected reason_ to be a str, received: {}".format(type(reason_))
            )
...
class IsMeteredResult(Type):
    ...
    def __init__(self, metered=None, **unknown_fields):
        ...
        if metered_ is not None and not isinstance(metered_, bool):
            raise Exception(
                "Expected metered_ to be a bool, received: {}".format(type(metered_))
            )
...
class ListCloudInfo(Type):
    ...
    def __init__(self, clouddetails=None, user_access=None, **unknown_fields):
        ...
        if user_access_ is not None and not isinstance(user_access_, (bytes, str)):
            raise Exception(
                "Expected user_access_ to be a str, received: {}".format(
                    type(user_access_)
                )
            )
...
class ListCloudInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ListCloudInfo)):
            raise Exception(
                "Expected result_ to be a ListCloudInfo, received: {}".format(
                    type(result_)
                )
            )
...
class ListCloudsRequest(Type):
    ...
    def __init__(self, all_=None, user_tag=None, **unknown_fields):
        ...
        if all__ is not None and not isinstance(all__, bool):
            raise Exception(
                "Expected all__ to be a bool, received: {}".format(type(all__))
            )
...
class ListFirewallRulesResults(Type):
    ...
    def __init__(self, rules=None, **unknown_fields):
        ...
        if rules_ is not None and not isinstance(rules_, (bytes, str, list)):
            raise Exception(
                "Expected rules_ to be a Sequence, received: {}".format(type(rules_))
            )
...
class ListSSHKeys(Type):
    ...
    def __init__(self, entities=None, mode=None, **unknown_fields):
        ...
        if entities_ is not None and not isinstance(entities_, (dict, Entities)):
            raise Exception(
                "Expected entities_ to be a Entities, received: {}".format(
                    type(entities_)
                )
            )
        ...
        if mode_ is not None and not isinstance(mode_, bool):
            raise Exception(
                "Expected mode_ to be a bool, received: {}".format(type(mode_))
            )
...
class ListSecretBackendsArgs(Type):
    ...
    def __init__(self, names=None, reveal=None, **unknown_fields):
        ...
        if reveal_ is not None and not isinstance(reveal_, bool):
            raise Exception(
                "Expected reveal_ to be a bool, received: {}".format(type(reveal_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if access_ is not None and not isinstance(access_, (bytes, str, list)):
            raise Exception(
                "Expected access_ to be a Sequence, received: {}".format(type(access_))
            )

        if create_time_ is not None and not isinstance(create_time_, (bytes, str)):
            raise Exception(
                "Expected create_time_ to be a str, received: {}".format(
                    type(create_time_)
                )
            )
        ...
        if latest_expire_time_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected latest_expire_time_ to be a str, received: {}".format(
                    type(latest_expire_time_)
                )
            )

        if latest_revision_ is not None and not isinstance(latest_revision_, int):
            raise Exception(
                "Expected latest_revision_ to be a int, received: {}".format(
                    type(latest_revision_)
                )
            )
        ...
        if latest_revision_checksum_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected latest_revision_checksum_ to be a str, received: {}".format(
                    type(latest_revision_checksum_)
                )
            )
        ...
        if next_rotate_time_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected next_rotate_time_ to be a str, received: {}".format(
                    type(next_rotate_time_)
                )
            )
        ...
        if update_time_ is not None and not isinstance(update_time_, (bytes, str)):
            raise Exception(
                "Expected update_time_ to be a str, received: {}".format(
                    type(update_time_)
                )
            )
        ...
        if value_ is not None and not isinstance(value_, (dict, SecretValueResult)):
            raise Exception(
                "Expected value_ to be a SecretValueResult, received: {}".format(
                    type(value_)
                )
            )
        ...
        if version_ is not None and not isinstance(version_, int):
            raise Exception(
                "Expected version_ to be a int, received: {}".format(type(version_))
            )
...
class ListSecretsArgs(Type):
    ...
    def __init__(self, filter_=None, show_secrets=None, **unknown_fields):
        ...
        if filter__ is not None and not isinstance(filter__, (dict, SecretsFilter)):
            raise Exception(
                "Expected filter__ to be a SecretsFilter, received: {}".format(
                    type(filter__)
                )
            )
        ...
        if show_secrets_ is not None and not isinstance(show_secrets_, bool):
            raise Exception(
                "Expected show_secrets_ to be a bool, received: {}".format(
                    type(show_secrets_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if auth_tag_ is not None and not isinstance(auth_tag_, (bytes, str)):
            raise Exception(
                "Expected auth_tag_ to be a str, received: {}".format(type(auth_tag_))
            )

        if bakery_version_ is not None and not isinstance(bakery_version_, int):
            raise Exception(
                "Expected bakery_version_ to be a int, received: {}".format(
                    type(bakery_version_)
                )
            )

        if cli_args_ is not None and not isinstance(cli_args_, (bytes, str)):
            raise Exception(
                "Expected cli_args_ to be a str, received: {}".format(type(cli_args_))
            )
        ...
        if client_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected client_version_ to be a str, received: {}".format(
                    type(client_version_)
                )
            )
        ...
        if macaroons_ is not None and not isinstance(macaroons_, (bytes, str, list)):
            raise Exception(
                "Expected macaroons_ to be a Sequence, received: {}".format(
                    type(macaroons_)
                )
            )
        ...
        if token_ is not None and not isinstance(token_, (bytes, str)):
            raise Exception(
                "Expected token_ to be a str, received: {}".format(type(token_))
            )

        if user_data_ is not None and not isinstance(user_data_, (bytes, str)):
            raise Exception(
                "Expected user_data_ to be a str, received: {}".format(type(user_data_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if bakery_discharge_required_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected bakery_discharge_required_ to be a Macaroon, received: {}".format(
                    type(bakery_discharge_required_)
                )
            )
        ...
        if discharge_required_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected discharge_required_ to be a Macaroon, received: {}".format(
                    type(discharge_required_)
                )
            )
        ...
        if discharge_required_error_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected discharge_required_error_ to be a str, received: {}".format(
                    type(discharge_required_error_)
                )
            )

        if facades_ is not None and not isinstance(facades_, (bytes, str, list)):
            raise Exception(
                "Expected facades_ to be a Sequence, received: {}".format(
                    type(facades_)
                )
            )
        ...
        if public_dns_name_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected public_dns_name_ to be a str, received: {}".format(
                    type(public_dns_name_)
                )
            )
        ...
        if server_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected server_version_ to be a str, received: {}".format(
                    type(server_version_)
                )
            )

        if servers_ is not None and not isinstance(servers_, (bytes, str, list)):
            raise Exception(
                "Expected servers_ to be a Sequence, received: {}".format(
                    type(servers_)
                )
            )
        ...
        if user_info_ is not None and not isinstance(user_info_, (dict, AuthUserInfo)):
            raise Exception(
                "Expected user_info_ to be a AuthUserInfo, received: {}".format(
                    type(user_info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cores_ is not None and not isinstance(cores_, int):
            raise Exception(
                "Expected cores_ to be a int, received: {}".format(type(cores_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if agent_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected agent_status_ to be a DetailedStatus, received: {}".format(
                    type(agent_status_)
                )
            )
        ...
        if constraints_ is not None and not isinstance(constraints_, (bytes, str)):
            raise Exception(
                "Expected constraints_ to be a str, received: {}".format(
                    type(constraints_)
                )
            )
        ...
        if dns_name_ is not None and not isinstance(dns_name_, (bytes, str)):
            raise Exception(
                "Expected dns_name_ to be a str, received: {}".format(type(dns_name_))
            )

        if hardware_ is not None and not isinstance(hardware_, (bytes, str)):
            raise Exception(
                "Expected hardware_ to be a str, received: {}".format(type(hardware_))
            )

        if has_vote_ is not None and not isinstance(has_vote_, bool):
            raise Exception(
                "Expected has_vote_ to be a bool, received: {}".format(type(has_vote_))
            )
        ...
        if instance_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected instance_status_ to be a DetailedStatus, received: {}".format(
                    type(instance_status_)
                )
            )
        ...
        if ip_addresses_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected ip_addresses_ to be a Sequence, received: {}".format(
                    type(ip_addresses_)
                )
            )
        ...
        if lxd_profiles_ is not None and not isinstance(lxd_profiles_, dict):
            raise Exception(
                "Expected lxd_profiles_ to be a Mapping, received: {}".format(
                    type(lxd_profiles_)
                )
            )
        ...
        if modification_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected modification_status_ to be a DetailedStatus, received: {}".format(
                    type(modification_status_)
                )
            )
        ...
        if network_interfaces_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected network_interfaces_ to be a Mapping, received: {}".format(
                    type(network_interfaces_)
                )
            )
        ...
        if primary_controller_machine_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected primary_controller_machine_ to be a bool, received: {}".format(
                    type(primary_controller_machine_)
                )
            )

        if wants_vote_ is not None and not isinstance(wants_vote_, bool):
            raise Exception(
                "Expected wants_vote_ to be a bool, received: {}".format(
                    type(wants_vote_)
                )
            )
...
class MapResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, dict):
            raise Exception(
                "Expected result_ to be a Mapping, received: {}".format(type(result_))
            )
...
class MetadataImageIds(Type):
    ...
    def __init__(self, image_ids=None, **unknown_fields):
        ...
        if image_ids_ is not None and not isinstance(image_ids_, (bytes, str, list)):
            raise Exception(
                "Expected image_ids_ to be a Sequence, received: {}".format(
                    type(image_ids_)
                )
            )
...
class MeterStatus(Type):
    ...
    def __init__(self, color=None, message=None, **unknown_fields):
        ...
        if color_ is not None and not isinstance(color_, (bytes, str)):
            raise Exception(
                "Expected color_ to be a str, received: {}".format(type(color_))
            )
...
class MeterStatusParams(Type):
    ...
    def __init__(self, statues=None, **unknown_fields):
        ...
        if statues_ is not None and not isinstance(statues_, (bytes, str, list)):
            raise Exception(
                "Expected statues_ to be a Sequence, received: {}".format(
                    type(statues_)
                )
            )
...
class MetricResult(Type):
    ...
    def __init__(
        ...
        if key_ is not None and not isinstance(key_, (bytes, str)):
            raise Exception(
                "Expected key_ to be a str, received: {}".format(type(key_))
            )

        if labels_ is not None and not isinstance(labels_, dict):
            raise Exception(
                "Expected labels_ to be a Mapping, received: {}".format(type(labels_))
            )

        if time_ is not None and not isinstance(time_, (bytes, str)):
            raise Exception(
                "Expected time_ to be a str, received: {}".format(type(time_))
            )

        if unit_ is not None and not isinstance(unit_, (bytes, str)):
            raise Exception(
                "Expected unit_ to be a str, received: {}".format(type(unit_))
            )
...
class MigrationSpec(Type):
    ...
    def __init__(self, model_tag=None, target_info=None, **unknown_fields):
        ...
        if target_info_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected target_info_ to be a MigrationTargetInfo, received: {}".format(
                    type(target_info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if macaroons_ is not None and not isinstance(macaroons_, (bytes, str)):
            raise Exception(
                "Expected macaroons_ to be a str, received: {}".format(type(macaroons_))
            )
...
class Model(Type):
    ...
    def __init__(
        ...
        if uuid_ is not None and not isinstance(uuid_, (bytes, str)):
            raise Exception(
                "Expected uuid_ to be a str, received: {}".format(type(uuid_))
            )
...
class ModelBlockInfo(Type):
    ...
    def __init__(
        ...
        if blocks_ is not None and not isinstance(blocks_, (bytes, str, list)):
            raise Exception(
                "Expected blocks_ to be a Sequence, received: {}".format(type(blocks_))
            )

        if model_uuid_ is not None and not isinstance(model_uuid_, (bytes, str)):
            raise Exception(
                "Expected model_uuid_ to be a str, received: {}".format(
                    type(model_uuid_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if credential_ is not None and not isinstance(credential_, (bytes, str)):
            raise Exception(
                "Expected credential_ to be a str, received: {}".format(
                    type(credential_)
                )
            )
...
class ModelDefaultValues(Type):
    ...
    def __init__(
        ...
        if cloud_region_ is not None and not isinstance(cloud_region_, (bytes, str)):
            raise Exception(
                "Expected cloud_region_ to be a str, received: {}".format(
                    type(cloud_region_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if detachable_ is not None and not isinstance(detachable_, bool):
            raise Exception(
                "Expected detachable_ to be a bool, received: {}".format(
                    type(detachable_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if agent_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected agent_version_ to be a Number, received: {}".format(
                    type(agent_version_)
                )
            )
        ...
        if cloud_credential_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected cloud_credential_tag_ to be a str, received: {}".format(
                    type(cloud_credential_tag_)
                )
            )
        ...
        if cloud_credential_validity_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected cloud_credential_validity_ to be a bool, received: {}".format(
                    type(cloud_credential_validity_)
                )
            )
        ...
        if default_base_ is not None and not isinstance(default_base_, (bytes, str)):
            raise Exception(
                "Expected default_base_ to be a str, received: {}".format(
                    type(default_base_)
                )
            )
        ...
        if default_series_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected default_series_ to be a str, received: {}".format(
                    type(default_series_)
                )
            )

        if is_controller_ is not None and not isinstance(is_controller_, bool):
            raise Exception(
                "Expected is_controller_ to be a bool, received: {}".format(
                    type(is_controller_)
                )
            )
        ...
        if migration_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected migration_ to be a ModelMigrationStatus, received: {}".format(
                    type(migration_)
                )
            )
        ...
        if provider_type_ is not None and not isinstance(provider_type_, (bytes, str)):
            raise Exception(
                "Expected provider_type_ to be a str, received: {}".format(
                    type(provider_type_)
                )
            )
        ...
        if secret_backends_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected secret_backends_ to be a Sequence, received: {}".format(
                    type(secret_backends_)
                )
            )

        if sla_ is not None and not isinstance(sla_, (dict, ModelSLAInfo)):
            raise Exception(
                "Expected sla_ to be a ModelSLAInfo, received: {}".format(type(sla_))
            )
        ...
        if supported_features_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected supported_features_ to be a Sequence, received: {}".format(
                    type(supported_features_)
                )
            )
...
class ModelInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ModelInfo)):
            raise Exception(
                "Expected result_ to be a ModelInfo, received: {}".format(type(result_))
            )
...
class ModelInstanceTypesConstraint(Type):
    ...
    def __init__(self, value=None, **unknown_fields):
        ...
        if value_ is not None and not isinstance(value_, (dict, Value)):
            raise Exception(
                "Expected value_ to be a Value, received: {}".format(type(value_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if ha_primary_ is not None and not isinstance(ha_primary_, bool):
            raise Exception(
                "Expected ha_primary_ to be a bool, received: {}".format(
                    type(ha_primary_)
                )
            )
        ...
        if hardware_ is not None and not isinstance(hardware_, (dict, MachineHardware)):
            raise Exception(
                "Expected hardware_ to be a MachineHardware, received: {}".format(
                    type(hardware_)
                )
            )
...
class ModelMigrationStatus(Type):
    ...
    def __init__(self, end=None, start=None, status=None, **unknown_fields):
        ...
        if end_ is not None and not isinstance(end_, (bytes, str)):
            raise Exception(
                "Expected end_ to be a str, received: {}".format(type(end_))
            )

        if start_ is not None and not isinstance(start_, (bytes, str)):
            raise Exception(
                "Expected start_ to be a str, received: {}".format(type(start_))
            )
...
class ModelSLA(Type):
    ...
    def __init__(
        ...
        if modelslainfo_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected modelslainfo_ to be a ModelSLAInfo, received: {}".format(
                    type(modelslainfo_)
                )
            )
        ...
        if level_ is not None and not isinstance(level_, (bytes, str)):
            raise Exception(
                "Expected level_ to be a str, received: {}".format(type(level_))
            )
...
class ModelSequencesResult(Type):
    ...
    def __init__(self, sequences=None, **unknown_fields):
        ...
        if sequences_ is not None and not isinstance(sequences_, dict):
            raise Exception(
                "Expected sequences_ to be a Mapping, received: {}".format(
                    type(sequences_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if application_count_ is not None and not isinstance(application_count_, int):
            raise Exception(
                "Expected application_count_ to be a int, received: {}".format(
                    type(application_count_)
                )
            )
        ...
        if hosted_machine_count_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected hosted_machine_count_ to be a int, received: {}".format(
                    type(hosted_machine_count_)
                )
            )
        ...
        if unit_count_ is not None and not isinstance(unit_count_, int):
            raise Exception(
                "Expected unit_count_ to be a int, received: {}".format(
                    type(unit_count_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if available_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected available_version_ to be a str, received: {}".format(
                    type(available_version_)
                )
            )
        ...
        if meter_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected meter_status_ to be a MeterStatus, received: {}".format(
                    type(meter_status_)
                )
            )
        ...
        if model_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected model_status_ to be a DetailedStatus, received: {}".format(
                    type(model_status_)
                )
            )
        ...
        if sla_ is not None and not isinstance(sla_, (bytes, str)):
            raise Exception(
                "Expected sla_ to be a str, received: {}".format(type(sla_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if counts_ is not None and not isinstance(counts_, (bytes, str, list)):
            raise Exception(
                "Expected counts_ to be a Sequence, received: {}".format(type(counts_))
            )
...
class ModelSummaryResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ModelSummary)):
            raise Exception(
                "Expected result_ to be a ModelSummary, received: {}".format(
                    type(result_)
                )
            )
...
class ModelUnset(Type):
    ...
    def __init__(self, keys=None, **unknown_fields):
        ...
        if keys_ is not None and not isinstance(keys_, (bytes, str, list)):
            raise Exception(
                "Expected keys_ to be a Sequence, received: {}".format(type(keys_))
            )
...
class ModelUserInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, ModelUserInfo)):
            raise Exception(
                "Expected result_ to be a ModelUserInfo, received: {}".format(
                    type(result_)
                )
            )
...
class ModifyCloudAccess(Type):
    ...
    def __init__(
        ...
        if action_ is not None and not isinstance(action_, (bytes, str)):
            raise Exception(
                "Expected action_ to be a str, received: {}".format(type(action_))
            )
...
class ModifyUserSSHKeys(Type):
    ...
    def __init__(self, ssh_keys=None, user=None, **unknown_fields):
        ...
        if ssh_keys_ is not None and not isinstance(ssh_keys_, (bytes, str, list)):
            raise Exception(
                "Expected ssh_keys_ to be a Sequence, received: {}".format(
                    type(ssh_keys_)
                )
            )
...
class MoveSubnetsParam(Type):
    ...
    def __init__(self, force=None, space_tag=None, subnets=None, **unknown_fields):
        ...
        if subnets_ is not None and not isinstance(subnets_, (bytes, str, list)):
            raise Exception(
                "Expected subnets_ to be a Sequence, received: {}".format(
                    type(subnets_)
                )
            )
...
class MoveSubnetsResult(Type):
    ...
    def __init__(
        ...
        if moved_subnets_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected moved_subnets_ to be a Sequence, received: {}".format(
                    type(moved_subnets_)
                )
            )
        ...
        if new_space_ is not None and not isinstance(new_space_, (bytes, str)):
            raise Exception(
                "Expected new_space_ to be a str, received: {}".format(type(new_space_))
            )
...
class MovedSubnet(Type):
    ...
    def __init__(self, cidr=None, old_space=None, subnet=None, **unknown_fields):
        ...
        if old_space_ is not None and not isinstance(old_space_, (bytes, str)):
            raise Exception(
                "Expected old_space_ to be a str, received: {}".format(type(old_space_))
            )

        if subnet_ is not None and not isinstance(subnet_, (bytes, str)):
            raise Exception(
                "Expected subnet_ to be a str, received: {}".format(type(subnet_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if dns_nameservers_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected dns_nameservers_ to be a Sequence, received: {}".format(
                    type(dns_nameservers_)
                )
            )

        if gateway_ is not None and not isinstance(gateway_, (bytes, str)):
            raise Exception(
                "Expected gateway_ to be a str, received: {}".format(type(gateway_))
            )
        ...
        if is_up_ is not None and not isinstance(is_up_, bool):
            raise Exception(
                "Expected is_up_ to be a bool, received: {}".format(type(is_up_))
            )

        if mac_address_ is not None and not isinstance(mac_address_, (bytes, str)):
            raise Exception(
                "Expected mac_address_ to be a str, received: {}".format(
                    type(mac_address_)
                )
            )
        ...
        if space_ is not None and not isinstance(space_, (bytes, str)):
            raise Exception(
                "Expected space_ to be a str, received: {}".format(type(space_))
            )
...
class NotifyWatchResult(Type):
    ...
    def __init__(self, notifywatcherid=None, error=None, **unknown_fields):
        ...
        if notifywatcherid_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected notifywatcherid_ to be a str, received: {}".format(
                    type(notifywatcherid_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if ingress_subnets_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected ingress_subnets_ to be a Sequence, received: {}".format(
                    type(ingress_subnets_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if allowed_users_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected allowed_users_ to be a Sequence, received: {}".format(
                    type(allowed_users_)
                )
            )
        ...
        if application_user_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected application_user_ to be a str, received: {}".format(
                    type(application_user_)
                )
            )
        ...
        if connected_users_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected connected_users_ to be a Sequence, received: {}".format(
                    type(connected_users_)
                )
            )
        ...
        if model_name_ is not None and not isinstance(model_name_, (bytes, str)):
            raise Exception(
                "Expected model_name_ to be a str, received: {}".format(
                    type(model_name_)
                )
            )
        ...
        if owner_name_ is not None and not isinstance(owner_name_, (bytes, str)):
            raise Exception(
                "Expected owner_name_ to be a str, received: {}".format(
                    type(owner_name_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if offset_ is not None and not isinstance(offset_, int):
            raise Exception(
                "Expected offset_ to be a int, received: {}".format(type(offset_))
            )

        if status_ is not None and not isinstance(status_, (bytes, str, list)):
            raise Exception(
                "Expected status_ to be a Sequence, received: {}".format(type(status_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if fail_ is not None and not isinstance(fail_, (bytes, str)):
            raise Exception(
                "Expected fail_ to be a str, received: {}".format(type(fail_))
            )
...
class OperationResults(Type):
    ...
    def __init__(self, results=None, truncated=None, **unknown_fields):
        ...
        if truncated_ is not None and not isinstance(truncated_, bool):
            raise Exception(
                "Expected truncated_ to be a bool, received: {}".format(
                    type(truncated_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if class__ is not None and not isinstance(class__, (bytes, str)):
            raise Exception(
                "Expected class__ to be a str, received: {}".format(type(class__))
            )
        ...
        if labels_ is not None and not isinstance(labels_, (bytes, str, list)):
            raise Exception(
                "Expected labels_ to be a Sequence, received: {}".format(type(labels_))
            )
...
class PayloadListArgs(Type):
    ...
    def __init__(self, patterns=None, **unknown_fields):
        ...
        if patterns_ is not None and not isinstance(patterns_, (bytes, str, list)):
            raise Exception(
                "Expected patterns_ to be a Sequence, received: {}".format(
                    type(patterns_)
                )
            )
...
class Placement(Type):
    ...
    def __init__(self, directive=None, scope=None, **unknown_fields):
        ...
        if directive_ is not None and not isinstance(directive_, (bytes, str)):
            raise Exception(
                "Expected directive_ to be a str, received: {}".format(type(directive_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if data_dir_ is not None and not isinstance(data_dir_, (bytes, str)):
            raise Exception(
                "Expected data_dir_ to be a str, received: {}".format(type(data_dir_))
            )
        ...
        if disable_package_commands_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected disable_package_commands_ to be a bool, received: {}".format(
                    type(disable_package_commands_)
                )
            )
...
class ProvisioningScriptResult(Type):
    ...
    def __init__(self, script=None, **unknown_fields):
        ...
        if script_ is not None and not isinstance(script_, (bytes, str)):
            raise Exception(
                "Expected script_ to be a str, received: {}".format(type(script_))
            )
...
class RegionDefaults(Type):
    ...
    def __init__(self, region_name=None, value=None, **unknown_fields):
        ...
        if region_name_ is not None and not isinstance(region_name_, (bytes, str)):
            raise Exception(
                "Expected region_name_ to be a str, received: {}".format(
                    type(region_name_)
                )
            )
...
class RelationData(Type):
    ...
    def __init__(self, inscope=None, unitdata=None, **unknown_fields):
        ...
        if inscope_ is not None and not isinstance(inscope_, bool):
            raise Exception(
                "Expected inscope_ to be a bool, received: {}".format(type(inscope_))
            )

        if unitdata_ is not None and not isinstance(unitdata_, dict):
            raise Exception(
                "Expected unitdata_ to be a Mapping, received: {}".format(
                    type(unitdata_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if id__ is not None and not isinstance(id__, int):
            raise Exception(
                "Expected id__ to be a int, received: {}".format(type(id__))
            )
...
class RelationSuspendedArg(Type):
    ...
    def __init__(
        ...
        if suspended_ is not None and not isinstance(suspended_, bool):
            raise Exception(
                "Expected suspended_ to be a bool, received: {}".format(
                    type(suspended_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if icon_url_path_ is not None and not isinstance(icon_url_path_, (bytes, str)):
            raise Exception(
                "Expected icon_url_path_ to be a str, received: {}".format(
                    type(icon_url_path_)
                )
            )
        ...
        if source_model_label_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected source_model_label_ to be a str, received: {}".format(
                    type(source_model_label_)
                )
            )
...
class RemoteApplicationInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected result_ to be a RemoteApplicationInfo, received: {}".format(
                    type(result_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if cloud_type_ is not None and not isinstance(cloud_type_, (bytes, str)):
            raise Exception(
                "Expected cloud_type_ to be a str, received: {}".format(
                    type(cloud_type_)
                )
            )
        ...
        if provider_attributes_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected provider_attributes_ to be a Mapping, received: {}".format(
                    type(provider_attributes_)
                )
            )
...
class RemoveSpaceParam(Type):
    ...
    def __init__(self, dry_run=None, force=None, space=None, **unknown_fields):
        ...
        if space_ is not None and not isinstance(space_, (dict, Entity)):
            raise Exception(
                "Expected space_ to be a Entity, received: {}".format(type(space_))
            )
...
class RemoveSpaceParams(Type):
    ...
    def __init__(self, space_param=None, **unknown_fields):
        ...
        if space_param_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected space_param_ to be a Sequence, received: {}".format(
                    type(space_param_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if bindings_ is not None and not isinstance(bindings_, (bytes, str, list)):
            raise Exception(
                "Expected bindings_ to be a Sequence, received: {}".format(
                    type(bindings_)
                )
            )
        ...
        if controller_settings_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected controller_settings_ to be a Sequence, received: {}".format(
                    type(controller_settings_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if destroy_attachments_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected destroy_attachments_ to be a bool, received: {}".format(
                    type(destroy_attachments_)
                )
            )
...
class RenameSpaceParams(Type):
    ...
    def __init__(self, from_space_tag=None, to_space_tag=None, **unknown_fields):
        ...
        if from_space_tag_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected from_space_tag_ to be a str, received: {}".format(
                    type(from_space_tag_)
                )
            )

        if to_space_tag_ is not None and not isinstance(to_space_tag_, (bytes, str)):
            raise Exception(
                "Expected to_space_tag_ to be a str, received: {}".format(
                    type(to_space_tag_)
                )
            )
...
class ResolveCharmWithChannel(Type):
    ...
    def __init__(
        ...
        if reference_ is not None and not isinstance(reference_, (bytes, str)):
            raise Exception(
                "Expected reference_ to be a str, received: {}".format(type(reference_))
            )

        if switch_charm_ is not None and not isinstance(switch_charm_, bool):
            raise Exception(
                "Expected switch_charm_ to be a bool, received: {}".format(
                    type(switch_charm_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if supported_bases_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected supported_bases_ to be a Sequence, received: {}".format(
                    type(supported_bases_)
                )
            )
...
class ResolveCharmsWithChannel(Type):
    ...
    def __init__(self, macaroon=None, resolve=None, **unknown_fields):
        ...
        if resolve_ is not None and not isinstance(resolve_, (bytes, str, list)):
            raise Exception(
                "Expected resolve_ to be a Sequence, received: {}".format(
                    type(resolve_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if pending_id_ is not None and not isinstance(pending_id_, (bytes, str)):
            raise Exception(
                "Expected pending_id_ to be a str, received: {}".format(
                    type(pending_id_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if charm_store_resources_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected charm_store_resources_ to be a Sequence, received: {}".format(
                    type(charm_store_resources_)
                )
            )
        ...
        if unit_resources_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected unit_resources_ to be a Sequence, received: {}".format(
                    type(unit_resources_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if commands_ is not None and not isinstance(commands_, (bytes, str)):
            raise Exception(
                "Expected commands_ to be a str, received: {}".format(type(commands_))
            )
        ...
        if workload_context_ is not None and not isinstance(workload_context_, bool):
            raise Exception(
                "Expected workload_context_ to be a bool, received: {}".format(
                    type(workload_context_)
                )
            )
...
class SSHAddressResult(Type):
    ...
    def __init__(self, address=None, error=None, **unknown_fields):
        ...
        if address_ is not None and not isinstance(address_, (bytes, str)):
            raise Exception(
                "Expected address_ to be a str, received: {}".format(type(address_))
            )
...
class SSHProxyResult(Type):
    ...
    def __init__(self, use_proxy=None, **unknown_fields):
        ...
        if use_proxy_ is not None and not isinstance(use_proxy_, bool):
            raise Exception(
                "Expected use_proxy_ to be a bool, received: {}".format(
                    type(use_proxy_)
                )
            )
...
class SSHPublicKeysResult(Type):
    ...
    def __init__(self, error=None, public_keys=None, **unknown_fields):
        ...
        if public_keys_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected public_keys_ to be a Sequence, received: {}".format(
                    type(public_keys_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if scale_ is not None and not isinstance(scale_, int):
            raise Exception(
                "Expected scale_ to be a int, received: {}".format(type(scale_))
            )

        if scale_change_ is not None and not isinstance(scale_change_, int):
            raise Exception(
                "Expected scale_change_ to be a int, received: {}".format(
                    type(scale_change_)
                )
            )
...
class ScaleApplicationResult(Type):
    ...
    def __init__(self, error=None, info=None, **unknown_fields):
        ...
        if info_ is not None and not isinstance(info_, (dict, ScaleApplicationInfo)):
            raise Exception(
                "Expected info_ to be a ScaleApplicationInfo, received: {}".format(
                    type(info_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if num_secrets_ is not None and not isinstance(num_secrets_, int):
            raise Exception(
                "Expected num_secrets_ to be a int, received: {}".format(
                    type(num_secrets_)
                )
            )
        ...
        if result_ is not None and not isinstance(result_, (dict, SecretBackend)):
            raise Exception(
                "Expected result_ to be a SecretBackend, received: {}".format(
                    type(result_)
                )
            )
...
class SecretContentParams(Type):
    ...
    def __init__(self, checksum=None, data=None, value_ref=None, **unknown_fields):
        ...
        if value_ref_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected value_ref_ to be a SecretValueRef, received: {}".format(
                    type(value_ref_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if backend_name_ is not None and not isinstance(backend_name_, (bytes, str)):
            raise Exception(
                "Expected backend_name_ to be a str, received: {}".format(
                    type(backend_name_)
                )
            )
...
class SecretValueRef(Type):
    ...
    def __init__(self, backend_id=None, revision_id=None, **unknown_fields):
        ...
        if backend_id_ is not None and not isinstance(backend_id_, (bytes, str)):
            raise Exception(
                "Expected backend_id_ to be a str, received: {}".format(
                    type(backend_id_)
                )
            )
        ...
        if revision_id_ is not None and not isinstance(revision_id_, (bytes, str)):
            raise Exception(
                "Expected revision_id_ to be a str, received: {}".format(
                    type(revision_id_)
                )
            )
...
class SetModelDefaults(Type):
    ...
    def __init__(self, config=None, **unknown_fields):
        ...
        if config_ is not None and not isinstance(config_, (bytes, str, list)):
            raise Exception(
                "Expected config_ to be a Sequence, received: {}".format(type(config_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if machine_count_ is not None and not isinstance(machine_count_, int):
            raise Exception(
                "Expected machine_count_ to be a int, received: {}".format(
                    type(machine_count_)
                )
            )
        ...
        if space_ is not None and not isinstance(space_, (dict, Space)):
            raise Exception(
                "Expected space_ to be a Space, received: {}".format(type(space_))
            )
...
class StatusHistoryFilter(Type):
    ...
    def __init__(
        ...
        if date_ is not None and not isinstance(date_, (bytes, str)):
            raise Exception(
                "Expected date_ to be a str, received: {}".format(type(date_))
            )

        if delta_ is not None and not isinstance(delta_, int):
            raise Exception(
                "Expected delta_ to be a int, received: {}".format(type(delta_))
            )

        if exclude_ is not None and not isinstance(exclude_, (bytes, str, list)):
            raise Exception(
                "Expected exclude_ to be a Sequence, received: {}".format(
                    type(exclude_)
                )
            )
...
class StatusHistoryRequest(Type):
    ...
    def __init__(
        ...
        if filter__ is not None and not isinstance(
            ...
            raise Exception(
                "Expected filter__ to be a StatusHistoryFilter, received: {}".format(
                    type(filter__)
                )
            )
        ...
        if historykind_ is not None and not isinstance(historykind_, (bytes, str)):
            raise Exception(
                "Expected historykind_ to be a str, received: {}".format(
                    type(historykind_)
                )
            )
...
class StatusHistoryRequests(Type):
    ...
    def __init__(self, requests=None, **unknown_fields):
        ...
        if requests_ is not None and not isinstance(requests_, (bytes, str, list)):
            raise Exception(
                "Expected requests_ to be a Sequence, received: {}".format(
                    type(requests_)
                )
            )
...
class StatusHistoryResult(Type):
    ...
    def __init__(self, error=None, history=None, **unknown_fields):
        ...
        if history_ is not None and not isinstance(history_, (dict, History)):
            raise Exception(
                "Expected history_ to be a History, received: {}".format(type(history_))
            )
...
class StatusParams(Type):
    ...
    def __init__(self, include_storage=None, patterns=None, **unknown_fields):
        ...
        if include_storage_ is not None and not isinstance(include_storage_, bool):
            raise Exception(
                "Expected include_storage_ to be a bool, received: {}".format(
                    type(include_storage_)
                )
            )
...
class StorageAddParams(Type):
    ...
    def __init__(self, name=None, storage=None, unit=None, **unknown_fields):
        ...
        if storage_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_ to be a StorageConstraints, received: {}".format(
                    type(storage_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if machine_tag_ is not None and not isinstance(machine_tag_, (bytes, str)):
            raise Exception(
                "Expected machine_tag_ to be a str, received: {}".format(
                    type(machine_tag_)
                )
            )
...
class StorageAttachmentIds(Type):
    ...
    def __init__(self, ids=None, **unknown_fields):
        ...
        if ids_ is not None and not isinstance(ids_, (bytes, str, list)):
            raise Exception(
                "Expected ids_ to be a Sequence, received: {}".format(type(ids_))
            )
...
class StorageDetachmentParams(Type):
    ...
    def __init__(self, force=None, ids=None, max_wait=None, **unknown_fields):
        ...
        if ids_ is not None and not isinstance(ids_, (dict, StorageAttachmentIds)):
            raise Exception(
                "Expected ids_ to be a StorageAttachmentIds, received: {}".format(
                    type(ids_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if attachments_ is not None and not isinstance(attachments_, dict):
            raise Exception(
                "Expected attachments_ to be a Mapping, received: {}".format(
                    type(attachments_)
                )
            )
        ...
        if persistent_ is not None and not isinstance(persistent_, bool):
            raise Exception(
                "Expected persistent_ to be a bool, received: {}".format(
                    type(persistent_)
                )
            )
...
class StorageDetailsResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, StorageDetails)):
            raise Exception(
                "Expected result_ to be a StorageDetails, received: {}".format(
                    type(result_)
                )
            )
...
class StoragePool(Type):
    ...
    def __init__(self, attrs=None, name=None, provider=None, **unknown_fields):
        ...
        if provider_ is not None and not isinstance(provider_, (bytes, str)):
            raise Exception(
                "Expected provider_ to be a str, received: {}".format(type(provider_))
            )
...
class StoragePoolArgs(Type):
    ...
    def __init__(self, pools=None, **unknown_fields):
        ...
        if pools_ is not None and not isinstance(pools_, (bytes, str, list)):
            raise Exception(
                "Expected pools_ to be a Sequence, received: {}".format(type(pools_))
            )
...
class StoragePoolFilter(Type):
    ...
    def __init__(self, names=None, providers=None, **unknown_fields):
        ...
        if providers_ is not None and not isinstance(providers_, (bytes, str, list)):
            raise Exception(
                "Expected providers_ to be a Sequence, received: {}".format(
                    type(providers_)
                )
            )
...
class StoragePoolsResult(Type):
    ...
    def __init__(self, error=None, storage_pools=None, **unknown_fields):
        ...
        if storage_pools_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_pools_ to be a Sequence, received: {}".format(
                    type(storage_pools_)
                )
            )
...
class StoragesAddParams(Type):
    ...
    def __init__(self, storages=None, **unknown_fields):
        ...
        if storages_ is not None and not isinstance(storages_, (bytes, str, list)):
            raise Exception(
                "Expected storages_ to be a Sequence, received: {}".format(
                    type(storages_)
                )
            )
...
class StringResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (bytes, str)):
            raise Exception(
                "Expected result_ to be a str, received: {}".format(type(result_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if provider_network_id_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected provider_network_id_ to be a str, received: {}".format(
                    type(provider_network_id_)
                )
            )
        ...
        if provider_space_id_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected provider_space_id_ to be a str, received: {}".format(
                    type(provider_space_id_)
                )
            )
        ...
        if vlan_tag_ is not None and not isinstance(vlan_tag_, int):
            raise Exception(
                "Expected vlan_tag_ to be a int, received: {}".format(type(vlan_tag_))
            )

        if zones_ is not None and not isinstance(zones_, (bytes, str, list)):
            raise Exception(
                "Expected zones_ to be a Sequence, received: {}".format(type(zones_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if subnet_ is not None and not isinstance(subnet_, (dict, Subnet)):
            raise Exception(
                "Expected subnet_ to be a Subnet, received: {}".format(type(subnet_))
            )
...
class SubnetsFilters(Type):
    ...
    def __init__(self, space_tag=None, zone=None, **unknown_fields):
        ...
        if zone_ is not None and not isinstance(zone_, (bytes, str)):
            raise Exception(
                "Expected zone_ to be a str, received: {}".format(type(zone_))
            )
...
class Tools(Type):
    ...
    def __init__(
        ...
        if sha256_ is not None and not isinstance(sha256_, (bytes, str)):
            raise Exception(
                "Expected sha256_ to be a str, received: {}".format(type(sha256_))
            )
        ...
        if version_ is not None and not isinstance(version_, (dict, Binary)):
            raise Exception(
                "Expected version_ to be a Binary, received: {}".format(type(version_))
            )
...
class UnitInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, UnitResult)):
            raise Exception(
                "Expected result_ to be a UnitResult, received: {}".format(
                    type(result_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if download_progress_ is not None and not isinstance(download_progress_, dict):
            raise Exception(
                "Expected download_progress_ to be a Mapping, received: {}".format(
                    type(download_progress_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if leader_ is not None and not isinstance(leader_, bool):
            raise Exception(
                "Expected leader_ to be a bool, received: {}".format(type(leader_))
            )
        ...
        if opened_ports_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected opened_ports_ to be a Sequence, received: {}".format(
                    type(opened_ports_)
                )
            )
        ...
        if relation_data_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected relation_data_ to be a Sequence, received: {}".format(
                    type(relation_data_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if subordinates_ is not None and not isinstance(subordinates_, dict):
            raise Exception(
                "Expected subordinates_ to be a Mapping, received: {}".format(
                    type(subordinates_)
                )
            )
        ...
        if workload_status_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected workload_status_ to be a DetailedStatus, received: {}".format(
                    type(workload_status_)
                )
            )
...
class UnitsResolved(Type):
    ...
    def __init__(self, all_=None, retry=None, tags=None, **unknown_fields):
        ...
        if retry_ is not None and not isinstance(retry_, bool):
            raise Exception(
                "Expected retry_ to be a bool, received: {}".format(type(retry_))
            )

        if tags_ is not None and not isinstance(tags_, (dict, Entities)):
            raise Exception(
                "Expected tags_ to be a Entities, received: {}".format(type(tags_))
            )
...
class UpdateChannelArg(Type):
    ...
    def __init__(self, channel=None, force=None, tag=None, **unknown_fields):
        ...
        if tag_ is not None and not isinstance(tag_, (dict, Entity)):
            raise Exception(
                "Expected tag_ to be a Entity, received: {}".format(type(tag_))
            )
...
class UpdateCloudArgs(Type):
    ...
    def __init__(self, clouds=None, **unknown_fields):
        ...
        if clouds_ is not None and not isinstance(clouds_, (bytes, str, list)):
            raise Exception(
                "Expected clouds_ to be a Sequence, received: {}".format(type(clouds_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if name_change_ is not None and not isinstance(name_change_, (bytes, str)):
            raise Exception(
                "Expected name_change_ to be a str, received: {}".format(
                    type(name_change_)
                )
            )
        ...
        if reset_ is not None and not isinstance(reset_, (bytes, str, list)):
            raise Exception(
                "Expected reset_ to be a Sequence, received: {}".format(type(reset_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if auto_prune_ is not None and not isinstance(auto_prune_, bool):
            raise Exception(
                "Expected auto_prune_ to be a bool, received: {}".format(
                    type(auto_prune_)
                )
            )
        ...
        if existing_label_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected existing_label_ to be a str, received: {}".format(
                    type(existing_label_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if agent_stream_ is not None and not isinstance(agent_stream_, (bytes, str)):
            raise Exception(
                "Expected agent_stream_ to be a str, received: {}".format(
                    type(agent_stream_)
                )
            )
        ...
        if ignore_agent_versions_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected ignore_agent_versions_ to be a bool, received: {}".format(
                    type(ignore_agent_versions_)
                )
            )
        ...
        if target_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected target_version_ to be a Number, received: {}".format(
                    type(target_version_)
                )
            )
...
class UpgradeModelResult(Type):
    ...
    def __init__(self, chosen_version=None, error=None, **unknown_fields):
        ...
        if chosen_version_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected chosen_version_ to be a Number, received: {}".format(
                    type(chosen_version_)
                )
            )
...
class UpgradeSeriesUnitsResult(Type):
    ...
    def __init__(self, error=None, unit_names=None, **unknown_fields):
        ...
        if unit_names_ is not None and not isinstance(unit_names_, (bytes, str, list)):
            raise Exception(
                "Expected unit_names_ to be a Sequence, received: {}".format(
                    type(unit_names_)
                )
            )
...
class UserAccessResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, UserAccess)):
            raise Exception(
                "Expected result_ to be a UserAccess, received: {}".format(
                    type(result_)
                )
            )
...
class UserClouds(Type):
    ...
    def __init__(self, user_clouds=None, **unknown_fields):
        ...
        if user_clouds_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected user_clouds_ to be a Sequence, received: {}".format(
                    type(user_clouds_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if date_created_ is not None and not isinstance(date_created_, (bytes, str)):
            raise Exception(
                "Expected date_created_ to be a str, received: {}".format(
                    type(date_created_)
                )
            )
        ...
        if disabled_ is not None and not isinstance(disabled_, bool):
            raise Exception(
                "Expected disabled_ to be a bool, received: {}".format(type(disabled_))
            )
...
class UserInfoRequest(Type):
    ...
    def __init__(self, entities=None, include_disabled=None, **unknown_fields):
        ...
        if include_disabled_ is not None and not isinstance(include_disabled_, bool):
            raise Exception(
                "Expected include_disabled_ to be a bool, received: {}".format(
                    type(include_disabled_)
                )
            )
...
class UserInfoResult(Type):
    ...
    def __init__(self, error=None, result=None, **unknown_fields):
        ...
        if result_ is not None and not isinstance(result_, (dict, UserInfo)):
            raise Exception(
                "Expected result_ to be a UserInfo, received: {}".format(type(result_))
            )
...
class UserModel(Type):
    ...
    def __init__(self, last_connection=None, model=None, **unknown_fields):
        ...
        if model_ is not None and not isinstance(model_, (dict, Model)):
            raise Exception(
                "Expected model_ to be a Model, received: {}".format(type(model_))
            )
...
class UserModelList(Type):
    ...
    def __init__(self, user_models=None, **unknown_fields):
        ...
        if user_models_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected user_models_ to be a Sequence, received: {}".format(
                    type(user_models_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if allocate_public_ip_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected allocate_public_ip_ to be a bool, received: {}".format(
                    type(allocate_public_ip_)
                )
            )
        ...
        if container_ is not None and not isinstance(container_, (bytes, str)):
            raise Exception(
                "Expected container_ to be a str, received: {}".format(type(container_))
            )
        ...
        if instance_role_ is not None and not isinstance(instance_role_, (bytes, str)):
            raise Exception(
                "Expected instance_role_ to be a str, received: {}".format(
                    type(instance_role_)
                )
            )
        ...
        if instance_type_ is not None and not isinstance(instance_type_, (bytes, str)):
            raise Exception(
                "Expected instance_type_ to be a str, received: {}".format(
                    type(instance_type_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if volumeattachmentinfo_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected volumeattachmentinfo_ to be a VolumeAttachmentInfo, received: {}".format(
        ...
        if bus_address_ is not None and not isinstance(bus_address_, (bytes, str)):
            raise Exception(
                "Expected bus_address_ to be a str, received: {}".format(
                    type(bus_address_)
                )
            )
        ...
        if device_link_ is not None and not isinstance(device_link_, (bytes, str)):
            raise Exception(
                "Expected device_link_ to be a str, received: {}".format(
                    type(device_link_)
                )
            )
        ...
        if device_name_ is not None and not isinstance(device_name_, (bytes, str)):
            raise Exception(
                "Expected device_name_ to be a str, received: {}".format(
                    type(device_name_)
                )
            )
        ...
        if plan_info_ is not None and not isinstance(
            ...
            raise Exception(
                "Expected plan_info_ to be a VolumeAttachmentPlanInfo, received: {}".format(
                    type(plan_info_)
                )
            )
...
class VolumeAttachmentPlanInfo(Type):
    ...
    def __init__(self, device_attributes=None, device_type=None, **unknown_fields):
        ...
        if device_attributes_ is not None and not isinstance(device_attributes_, dict):
            raise Exception(
                "Expected device_attributes_ to be a Mapping, received: {}".format(
                    type(device_attributes_)
                )
            )

        if device_type_ is not None and not isinstance(device_type_, (bytes, str)):
            raise Exception(
                "Expected device_type_ to be a str, received: {}".format(
                    type(device_type_)
                )
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if info_ is not None and not isinstance(info_, (dict, VolumeInfo)):
            raise Exception(
                "Expected info_ to be a VolumeInfo, received: {}".format(type(info_))
            )
    ...
    def __init__(
        ...
        **unknown_fields,
        ...
        if hardware_id_ is not None and not isinstance(hardware_id_, (bytes, str)):
            raise Exception(
                "Expected hardware_id_ to be a str, received: {}".format(
                    type(hardware_id_)
                )
            )
        ...
        if volume_id_ is not None and not isinstance(volume_id_, (bytes, str)):
            raise Exception(
                "Expected volume_id_ to be a str, received: {}".format(type(volume_id_))
            )

        if wwn_ is not None and not isinstance(wwn_, (bytes, str)):
            raise Exception(
                "Expected wwn_ to be a str, received: {}".format(type(wwn_))
            )
...
class ZoneResult(Type):
    ...
    def __init__(self, available=None, error=None, name=None, **unknown_fields):
        ...
        if available_ is not None and not isinstance(available_, bool):
            raise Exception(
                "Expected available_ to be a bool, received: {}".format(
                    type(available_)
                )
            )
