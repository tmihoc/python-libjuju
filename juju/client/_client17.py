...
class ApplicationFacade(Type):
    ...
    async def AddRelation(self, endpoints=None, via_cidrs=None):
        ...
        if endpoints is not None and not isinstance(endpoints, (bytes, str, list)):
            raise Exception(
                "Expected endpoints to be a Sequence, received: {}".format(
                    type(endpoints)
                )
            )
        ...
        if via_cidrs is not None and not isinstance(via_cidrs, (bytes, str, list)):
            raise Exception(
                "Expected via_cidrs to be a Sequence, received: {}".format(
                    type(via_cidrs)
                )
            )
    ...
    async def AddUnits(
        ...
        if application is not None and not isinstance(application, (bytes, str)):
            raise Exception(
                "Expected application to be a str, received: {}".format(
                    type(application)
                )
            )
        ...
        if attach_storage is not None and not isinstance(
            ...
            raise Exception(
                "Expected attach_storage to be a Sequence, received: {}".format(
                    type(attach_storage)
                )
            )
        ...
        if placement is not None and not isinstance(placement, (bytes, str, list)):
            raise Exception(
                "Expected placement to be a Sequence, received: {}".format(
                    type(placement)
                )
            )
        ...
        if policy is not None and not isinstance(policy, (bytes, str)):
            raise Exception(
                "Expected policy to be a str, received: {}".format(type(policy))
            )
    ...
    async def CharmConfig(self, args=None):
        ...
        if args is not None and not isinstance(args, (bytes, str, list)):
            raise Exception(
                "Expected args to be a Sequence, received: {}".format(type(args))
            )
    ...
    async def DestroyRelation(
        ...
        if max_wait is not None and not isinstance(max_wait, int):
            raise Exception(
                "Expected max_wait to be a int, received: {}".format(type(max_wait))
            )

        if relation_id is not None and not isinstance(relation_id, int):
            raise Exception(
                "Expected relation_id to be a int, received: {}".format(
                    type(relation_id)
                )
            )
    ...
    async def Expose(self, application=None, exposed_endpoints=None):
        ...
        if exposed_endpoints is not None and not isinstance(exposed_endpoints, dict):
            raise Exception(
                "Expected exposed_endpoints to be a Mapping, received: {}".format(
    ...
    async def ResolveUnitErrors(self, all_=None, retry=None, tags=None):
        ...
        if retry is not None and not isinstance(retry, bool):
            raise Exception(
                "Expected retry to be a bool, received: {}".format(type(retry))
            )

        if tags is not None and not isinstance(tags, (dict, Entities)):
            raise Exception(
                "Expected tags to be a Entities, received: {}".format(type(tags))
            )
    ...
    async def SetCharm(
        ...
        if channel is not None and not isinstance(channel, (bytes, str)):
            raise Exception(
                "Expected channel to be a str, received: {}".format(type(channel))
            )
        ...
        if charm_url is not None and not isinstance(charm_url, (bytes, str)):
            raise Exception(
                "Expected charm_url to be a str, received: {}".format(type(charm_url))
            )

        if config_settings is not None and not isinstance(config_settings, dict):
            raise Exception(
                "Expected config_settings to be a Mapping, received: {}".format(
        ...
        if config_settings_yaml is not None and not isinstance(
            ...
            raise Exception(
                "Expected config_settings_yaml to be a str, received: {}".format(
                    type(config_settings_yaml)
                )
            )

        if endpoint_bindings is not None and not isinstance(endpoint_bindings, dict):
            raise Exception(
                "Expected endpoint_bindings to be a Mapping, received: {}".format(
                    type(endpoint_bindings)
                )
            )
        ...
        if force_base is not None and not isinstance(force_base, bool):
            raise Exception(
                "Expected force_base to be a bool, received: {}".format(
                    type(force_base)
                )
            )
        ...
        if force_units is not None and not isinstance(force_units, bool):
            raise Exception(
                "Expected force_units to be a bool, received: {}".format(
                    type(force_units)
                )
            )
        ...
        if generation is not None and not isinstance(generation, (bytes, str)):
            raise Exception(
                "Expected generation to be a str, received: {}".format(type(generation))
            )

        if resource_ids is not None and not isinstance(resource_ids, dict):
            raise Exception(
                "Expected resource_ids to be a Mapping, received: {}".format(
                    type(resource_ids)
                )
            )
        ...
        if storage_constraints is not None and not isinstance(
            ...
            raise Exception(
                "Expected storage_constraints to be a Mapping, received: {}".format(
                    type(storage_constraints)
                )
            )
    ...
    async def SetConstraints(self, application=None, constraints=None):
        ...
        if constraints is not None and not isinstance(constraints, (dict, Value)):
            raise Exception(
                "Expected constraints to be a Value, received: {}".format(
                    type(constraints)
                )
            )
    ...
    async def SetMetricCredentials(self, creds=None):
        ...
        if creds is not None and not isinstance(creds, (bytes, str, list)):
            raise Exception(
                "Expected creds to be a Sequence, received: {}".format(type(creds))
            )
    ...
    async def Unexpose(self, application=None, exposed_endpoints=None):
        ...
        if exposed_endpoints is not None and not isinstance(
            ...
            raise Exception(
                "Expected exposed_endpoints to be a Sequence, received: {}".format(
                    type(exposed_endpoints)
                )
            )
